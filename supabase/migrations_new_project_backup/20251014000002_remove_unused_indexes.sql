...
-- NOTE: DROP INDEX  cannot run inside a transaction block
-- ============================================================================
...
DROP INDEX  IF EXISTS idx_search_analytics_clicked_product_id;
...
DROP INDEX  IF EXISTS products_status_active_idx;
...
DROP INDEX  IF EXISTS idx_products_boost_history_id;
DROP INDEX  IF EXISTS idx_products_drip_nominated_by;
DROP INDEX  IF EXISTS idx_products_drip_reviewed_by;
...
DROP INDEX  IF EXISTS idx_bundle_sessions_buyer_id;
DROP INDEX  IF EXISTS idx_bundle_sessions_seller_id;
...
DROP INDEX  IF EXISTS idx_conversations_participant_two_id;
...
DROP INDEX  IF EXISTS idx_drip_nominations_nominated_by;
DROP INDEX  IF EXISTS idx_drip_nominations_product_id;
DROP INDEX  IF EXISTS idx_drip_nominations_reviewed_by;
...
DROP INDEX  IF EXISTS idx_payout_requests_processed_by;
...
DROP INDEX  IF EXISTS idx_balance_history_created_by;
