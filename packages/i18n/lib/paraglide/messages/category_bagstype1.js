...
const en_category_bagstype1 = /** @type {(inputs: {}) => string} */ () => {
	return `Bags`
};

const bg_category_bagstype1 = /** @type {(inputs: {}) => string} */ () => {
	return `Чанти`
};
...
const category_bagstype1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_bagstype1(inputs)
	return bg_category_bagstype1(inputs)
};
