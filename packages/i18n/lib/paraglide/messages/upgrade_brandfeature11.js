...
const bg_upgrade_brandfeature11 = /** @type {(inputs: {}) => string} */ () => {
	return `Неограничени продукти`
};

const en_upgrade_brandfeature11 = /** @type {(inputs: {}) => string} */ () => {
...
const upgrade_brandfeature11 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_upgrade_brandfeature11(inputs)
	return en_upgrade_brandfeature11(inputs)
};
