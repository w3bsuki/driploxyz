...
const bg_messages_acceptoffer1 = /** @type {(inputs: {}) => string} */ () => {
	return `Приеми`
};

const en_messages_acceptoffer1 = /** @type {(inputs: {}) => string} */ () => {
	return `Accept`
};
...
const messages_acceptoffer1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_messages_acceptoffer1(inputs)
	return en_messages_acceptoffer1(inputs)
};
