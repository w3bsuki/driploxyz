...
const en_product_peopleviewing1 = /** @type {(inputs: {}) => string} */ () => {
	return `people viewing`
};

const bg_product_peopleviewing1 = /** @type {(inputs: {}) => string} */ () => {
	return `души гледат`
};
...
const product_peopleviewing1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_peopleviewing1(inputs)
	return bg_product_peopleviewing1(inputs)
};
