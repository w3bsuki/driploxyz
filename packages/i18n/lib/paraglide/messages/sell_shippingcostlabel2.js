...
const bg_sell_shippingcostlabel2 = /** @type {(inputs: {}) => string} */ () => {
	return `Цена за доставка`
};

const en_sell_shippingcostlabel2 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_shippingcostlabel2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_shippingcostlabel2(inputs)
	return en_sell_shippingcostlabel2(inputs)
};
