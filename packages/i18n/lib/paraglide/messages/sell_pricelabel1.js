...
const en_sell_pricelabel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Price`
};

const bg_sell_pricelabel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Цена`
};
...
const sell_pricelabel1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_pricelabel1(inputs)
	return bg_sell_pricelabel1(inputs)
};
