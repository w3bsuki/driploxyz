...
const en_bundle_itemstotal1 = /** @type {(inputs: {}) => string} */ () => {
	return `Items`
};

const bg_bundle_itemstotal1 = /** @type {(inputs: {}) => string} */ () => {
	return `Артикули`
};
...
const bundle_itemstotal1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_bundle_itemstotal1(inputs)
	return bg_bundle_itemstotal1(inputs)
};
