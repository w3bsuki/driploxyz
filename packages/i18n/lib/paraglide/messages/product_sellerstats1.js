...
const en_product_sellerstats1 = /** @type {(inputs: {}) => string} */ () => {
	return `Stats`
};

const bg_product_sellerstats1 = /** @type {(inputs: {}) => string} */ () => {
	return `Статистики`
};
...
const product_sellerstats1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_sellerstats1(inputs)
	return bg_product_sellerstats1(inputs)
};
