...
const en_sell_materialleather1 = /** @type {(inputs: {}) => string} */ () => {
	return `Leather`
};

const bg_sell_materialleather1 = /** @type {(inputs: {}) => string} */ () => {
	return `Кожа`
};
...
const sell_materialleather1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_materialleather1(inputs)
	return bg_sell_materialleather1(inputs)
};
