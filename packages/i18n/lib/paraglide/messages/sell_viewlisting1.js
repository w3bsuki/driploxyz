...
const bg_sell_viewlisting1 = /** @type {(inputs: {}) => string} */ () => {
	return `Виж обявата`
};

const en_sell_viewlisting1 = /** @type {(inputs: {}) => string} */ () => {
	return `View Listing`
};
...
const sell_viewlisting1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_viewlisting1(inputs)
	return en_sell_viewlisting1(inputs)
};
