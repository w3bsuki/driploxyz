...
const en_category_swimwear = /** @type {(inputs: {}) => string} */ () => {
	return `Swimwear`
};

const bg_category_swimwear = /** @type {(inputs: {}) => string} */ () => {
...
export const category_swimwear = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_swimwear(inputs)
	return bg_category_swimwear(inputs)
};