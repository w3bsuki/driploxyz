...
const bg_sell_colorwhite1 = /** @type {(inputs: {}) => string} */ () => {
	return `Бяло`
};

const en_sell_colorwhite1 = /** @type {(inputs: {}) => string} */ () => {
	return `White`
};
...
const sell_colorwhite1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_colorwhite1(inputs)
	return en_sell_colorwhite1(inputs)
};
