...
const en_sell_optimizedforweb2 = /** @type {(inputs: {}) => string} */ () => {
	return `Optimized for web`
};

const bg_sell_optimizedforweb2 = /** @type {(inputs: {}) => string} */ () => {
	return `Оптимизирано за уеб`
};
...
const sell_optimizedforweb2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_optimizedforweb2(inputs)
	return bg_sell_optimizedforweb2(inputs)
};
