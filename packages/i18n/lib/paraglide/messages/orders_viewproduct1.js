...
const bg_orders_viewproduct1 = /** @type {(inputs: {}) => string} */ () => {
	return `Виж продукта`
};

const en_orders_viewproduct1 = /** @type {(inputs: {}) => string} */ () => {
	return `View Product`
};
...
const orders_viewproduct1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_orders_viewproduct1(inputs)
	return en_orders_viewproduct1(inputs)
};
