...
const en_category_searchplaceholder1 = /** @type {(inputs: {}) => string} */ () => {
	return `Search in category...`
};

const bg_category_searchplaceholder1 = /** @type {(inputs: {}) => string} */ () => {
	return `Търси в категорията...`
};
...
const category_searchplaceholder1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_searchplaceholder1(inputs)
	return bg_category_searchplaceholder1(inputs)
};
