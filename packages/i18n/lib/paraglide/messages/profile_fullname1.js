...
const bg_profile_fullname1 = /** @type {(inputs: {}) => string} */ () => {
	return `Пълно име`
};

const en_profile_fullname1 = /** @type {(inputs: {}) => string} */ () => {
	return `Full Name`
};
...
const profile_fullname1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_profile_fullname1(inputs)
	return en_profile_fullname1(inputs)
};
