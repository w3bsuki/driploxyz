...
const bg_product_postedtime1 = /** @type {(inputs: {}) => string} */ () => {
	return `Публикувано`
};

const en_product_postedtime1 = /** @type {(inputs: {}) => string} */ () => {
	return `Posted`
};
...
const product_postedtime1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_product_postedtime1(inputs)
	return en_product_postedtime1(inputs)
};
