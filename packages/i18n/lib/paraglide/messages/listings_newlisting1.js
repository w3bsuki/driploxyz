...
const en_listings_newlisting1 = /** @type {(inputs: {}) => string} */ () => {
	return `New Listing`
};

const bg_listings_newlisting1 = /** @type {(inputs: {}) => string} */ () => {
	return `Нова обява`
};
...
const listings_newlisting1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_listings_newlisting1(inputs)
	return bg_listings_newlisting1(inputs)
};
