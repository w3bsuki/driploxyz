...
const en_product_monthsago1 = /** @type {(inputs: {}) => string} */ () => {
	return `mo ago`
};

const bg_product_monthsago1 = /** @type {(inputs: {}) => string} */ () => {
	return `м преди`
};
...
const product_monthsago1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_monthsago1(inputs)
	return bg_product_monthsago1(inputs)
};
