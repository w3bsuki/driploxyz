...
const en_notifications_viewall1 = /** @type {(inputs: {}) => string} */ () => {
	return `View all notifications`
};

const bg_notifications_viewall1 = /** @type {(inputs: {}) => string} */ () => {
	return `Виж всички известия`
};
...
const notifications_viewall1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_notifications_viewall1(inputs)
	return bg_notifications_viewall1(inputs)
};
