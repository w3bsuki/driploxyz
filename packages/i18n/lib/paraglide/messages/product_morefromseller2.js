...
const bg_product_morefromseller2 = /** @type {(inputs: {}) => string} */ () => {
	return `Още от`
};

const en_product_morefromseller2 = /** @type {(inputs: {}) => string} */ () => {
	return `More from`
};
...
const product_morefromseller2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_product_morefromseller2(inputs)
	return en_product_morefromseller2(inputs)
};
