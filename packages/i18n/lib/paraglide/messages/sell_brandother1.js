...
const bg_sell_brandother1 = /** @type {(inputs: {}) => string} */ () => {
	return `Друга`
};

const en_sell_brandother1 = /** @type {(inputs: {}) => string} */ () => {
	return `Other`
};
...
const sell_brandother1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_brandother1(inputs)
	return en_sell_brandother1(inputs)
};
