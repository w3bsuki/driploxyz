...
const bg_home_newestlistings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Най-нови обяви`
};

const en_home_newestlistings1 = /** @type {(inputs: {}) => string} */ () => {
...
const home_newestlistings1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_home_newestlistings1(inputs)
	return en_home_newestlistings1(inputs)
};
