...
const en_category_lunchbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Lunch Bags`
};

const bg_category_lunchbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Чанти за храна`
};
...
const category_lunchbags1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_lunchbags1(inputs)
	return bg_category_lunchbags1(inputs)
};
