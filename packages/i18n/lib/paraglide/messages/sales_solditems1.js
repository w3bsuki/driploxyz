...
const bg_sales_solditems1 = /** @type {(inputs: {}) => string} */ () => {
	return `Продадени артикули`
};

const en_sales_solditems1 = /** @type {(inputs: {}) => string} */ () => {
	return `Sold Items`
};
...
const sales_solditems1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sales_solditems1(inputs)
	return en_sales_solditems1(inputs)
};
