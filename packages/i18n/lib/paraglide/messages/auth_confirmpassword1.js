...
const en_auth_confirmpassword1 = /** @type {(inputs: {}) => string} */ () => {
	return `Confirm Password`
};

const bg_auth_confirmpassword1 = /** @type {(inputs: {}) => string} */ () => {
...
const auth_confirmpassword1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_auth_confirmpassword1(inputs)
	return bg_auth_confirmpassword1(inputs)
};
