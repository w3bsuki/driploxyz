...
const bg_sell_condition_brandnewwithtags3 = /** @type {(inputs: {}) => string} */ () => {
	return `Ново с етикети`
};

const en_sell_condition_brandnewwithtags3 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_condition_brandnewwithtags3 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_condition_brandnewwithtags3(inputs)
	return en_sell_condition_brandnewwithtags3(inputs)
};
