...
const bg_onboarding_permonth1 = /** @type {(inputs: {}) => string} */ () => {
	return `/ месец`
};

const en_onboarding_permonth1 = /** @type {(inputs: {}) => string} */ () => {
	return `per month`
};
...
const onboarding_permonth1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_onboarding_permonth1(inputs)
	return en_onboarding_permonth1(inputs)
};
