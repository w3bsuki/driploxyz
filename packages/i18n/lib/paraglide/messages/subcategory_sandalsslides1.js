...
/** @type {(inputs: {}) => string} */
const en_subcategory_sandalsslides1 = () => 'subcategory_sandalsSlides'
...
const subcategory_sandalsslides1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_subcategory_sandalsslides1(inputs)
	return bg_subcategory_sandalsslides1(inputs)
};
