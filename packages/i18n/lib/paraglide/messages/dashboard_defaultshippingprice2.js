...
const en_dashboard_defaultshippingprice2 = /** @type {(inputs: {}) => string} */ () => {
	return `Default Shipping Price`
};

const bg_dashboard_defaultshippingprice2 = /** @type {(inputs: {}) => string} */ () => {
	return `Стандартна цена за доставка`
};
...
const dashboard_defaultshippingprice2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_defaultshippingprice2(inputs)
	return bg_dashboard_defaultshippingprice2(inputs)
};
