...
const en_sell_gotodashboard2 = /** @type {(inputs: {}) => string} */ () => {
	return `Go to Dashboard`
};

const bg_sell_gotodashboard2 = /** @type {(inputs: {}) => string} */ () => {
	return `Към таблото`
};
...
const sell_gotodashboard2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_gotodashboard2(inputs)
	return bg_sell_gotodashboard2(inputs)
};
