...
const bg_settings_darkmode1 = /** @type {(inputs: {}) => string} */ () => {
	return `Тъмен режим`
};

const en_settings_darkmode1 = /** @type {(inputs: {}) => string} */ () => {
	return `Dark mode`
};
...
const settings_darkmode1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_settings_darkmode1(inputs)
	return en_settings_darkmode1(inputs)
};
