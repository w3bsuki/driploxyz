...
const bg_subcategory_haircare1 = /** @type {(inputs: {}) => string} */ () => {
	return `Грижа за коса`
};

const en_subcategory_haircare1 = /** @type {(inputs: {}) => string} */ () => {
	return `Hair Care`
};
...
const subcategory_haircare1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_subcategory_haircare1(inputs)
	return en_subcategory_haircare1(inputs)
};
