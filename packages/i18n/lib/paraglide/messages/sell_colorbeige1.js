...
const en_sell_colorbeige1 = /** @type {(inputs: {}) => string} */ () => {
	return `Beige`
};

const bg_sell_colorbeige1 = /** @type {(inputs: {}) => string} */ () => {
	return `Бежово`
};
...
const sell_colorbeige1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_colorbeige1(inputs)
	return bg_sell_colorbeige1(inputs)
};
