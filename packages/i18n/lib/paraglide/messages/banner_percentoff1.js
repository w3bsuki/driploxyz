...
const bg_banner_percentoff1 = /** @type {(inputs: {}) => string} */ () => {
	return `намаление`
};

const en_banner_percentoff1 = /** @type {(inputs: {}) => string} */ () => {
	return `off`
};
...
const banner_percentoff1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_banner_percentoff1(inputs)
	return en_banner_percentoff1(inputs)
};
