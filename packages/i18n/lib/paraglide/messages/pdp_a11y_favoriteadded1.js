...
const en_pdp_a11y_favoriteadded1 = /** @type {(inputs: {}) => string} */ () => {
	return `Added to favorites`
};

const bg_pdp_a11y_favoriteadded1 = /** @type {(inputs: {}) => string} */ () => {
	return `Добавен в любими`
};
...
const pdp_a11y_favoriteadded1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_pdp_a11y_favoriteadded1(inputs)
	return bg_pdp_a11y_favoriteadded1(inputs)
};
