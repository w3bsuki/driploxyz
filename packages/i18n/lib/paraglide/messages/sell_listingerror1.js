...
const en_sell_listingerror1 = /** @type {(inputs: {}) => string} */ () => {
	return `Failed to publish. Please try again.`
};

const bg_sell_listingerror1 = /** @type {(inputs: {}) => string} */ () => {
	return `Неуспешна публикация. Моля, опитайте отново.`
};
...
const sell_listingerror1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_listingerror1(inputs)
	return bg_sell_listingerror1(inputs)
};
