...
const bg_checkout_addaddress1 = /** @type {(inputs: {}) => string} */ () => {
	return `Добави адрес`
};

const en_checkout_addaddress1 = /** @type {(inputs: {}) => string} */ () => {
	return `Add address`
};
...
const checkout_addaddress1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_checkout_addaddress1(inputs)
	return en_checkout_addaddress1(inputs)
};
