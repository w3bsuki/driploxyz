...
/** @type {(inputs: {}) => string} */
const en_subcategory_lingerieunderwear1 = () => 'subcategory_lingerieUnderwear'
...
const subcategory_lingerieunderwear1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_subcategory_lingerieunderwear1(inputs)
	return bg_subcategory_lingerieunderwear1(inputs)
};
