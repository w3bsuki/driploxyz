...
const bg_subcategory_lingerieunderwear1 = /** @type {(inputs: {}) => string} */ () => {
	return `Бельо`
};

/** @type {(inputs: {}) => string} */
const en_subcategory_lingerieunderwear1 = bg_subcategory_lingerieunderwear1;
...
const subcategory_lingerieunderwear1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_subcategory_lingerieunderwear1(inputs)
	return en_subcategory_lingerieunderwear1(inputs)
};
