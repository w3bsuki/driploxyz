...
const bg_bundle_saveonshipping2 = /** @type {(inputs: {}) => string} */ () => {
	return `от доставка`
};

const en_bundle_saveonshipping2 = /** @type {(inputs: {}) => string} */ () => {
	return `on shipping`
};
...
const bundle_saveonshipping2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_bundle_saveonshipping2(inputs)
	return en_bundle_saveonshipping2(inputs)
};
