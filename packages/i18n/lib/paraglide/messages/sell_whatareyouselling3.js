...
const bg_sell_whatareyouselling3 = /** @type {(inputs: {}) => string} */ () => {
	return `Какво продавате?`
};

const en_sell_whatareyouselling3 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_whatareyouselling3 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_whatareyouselling3(inputs)
	return en_sell_whatareyouselling3(inputs)
};
