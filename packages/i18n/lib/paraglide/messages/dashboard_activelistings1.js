...
const en_dashboard_activelistings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Active Listings`
};

const bg_dashboard_activelistings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Активни обяви`
};
...
const dashboard_activelistings1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_activelistings1(inputs)
	return bg_dashboard_activelistings1(inputs)
};
