...
const en_sell_materialpolyester1 = /** @type {(inputs: {}) => string} */ () => {
	return `Polyester`
};

const bg_sell_materialpolyester1 = /** @type {(inputs: {}) => string} */ () => {
	return `Полиестер`
};
...
const sell_materialpolyester1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_materialpolyester1(inputs)
	return bg_sell_materialpolyester1(inputs)
};
