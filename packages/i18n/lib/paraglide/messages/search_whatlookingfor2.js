...
const bg_search_whatlookingfor2 = /** @type {(inputs: {}) => string} */ () => {
	return `Какво търсите?`
};

const en_search_whatlookingfor2 = /** @type {(inputs: {}) => string} */ () => {
...
const search_whatlookingfor2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_search_whatlookingfor2(inputs)
	return en_search_whatlookingfor2(inputs)
};
