...
const en_profile_myprofile1 = /** @type {(inputs: {}) => string} */ () => {
	return `My Profile`
};

const bg_profile_myprofile1 = /** @type {(inputs: {}) => string} */ () => {
	return `Моят профил`
};
...
const profile_myprofile1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_profile_myprofile1(inputs)
	return bg_profile_myprofile1(inputs)
};
