...
const bg_footer_allrightsreserved2 = /** @type {(inputs: {}) => string} */ () => {
	return `Всички права запазени.`
};

const en_footer_allrightsreserved2 = /** @type {(inputs: {}) => string} */ () => {
...
const footer_allrightsreserved2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_footer_allrightsreserved2(inputs)
	return en_footer_allrightsreserved2(inputs)
};
