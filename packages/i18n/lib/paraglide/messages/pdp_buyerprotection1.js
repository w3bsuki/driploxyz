...
const bg_pdp_buyerprotection1 = /** @type {(inputs: {}) => string} */ () => {
	return `Защита на купувача`
};

const en_pdp_buyerprotection1 = /** @type {(inputs: {}) => string} */ () => {
...
const pdp_buyerprotection1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_pdp_buyerprotection1(inputs)
	return en_pdp_buyerprotection1(inputs)
};
