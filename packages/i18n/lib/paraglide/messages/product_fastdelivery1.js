...
const en_product_fastdelivery1 = /** @type {(inputs: {}) => string} */ () => {
	return `Fast delivery`
};

const bg_product_fastdelivery1 = /** @type {(inputs: {}) => string} */ () => {
...
const product_fastdelivery1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_fastdelivery1(inputs)
	return bg_product_fastdelivery1(inputs)
};
