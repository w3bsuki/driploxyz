...
const bg_subcategory_tshirts1 = /** @type {(inputs: {}) => string} */ () => {
	return `Тениски`
};

/** @type {(inputs: {}) => string} */
const en_subcategory_tshirts1 = bg_subcategory_tshirts1;
...
const subcategory_tshirts1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_subcategory_tshirts1(inputs)
	return en_subcategory_tshirts1(inputs)
};
