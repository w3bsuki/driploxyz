...
const en_sell_colorred1 = /** @type {(inputs: {}) => string} */ () => {
	return `Red`
};

const bg_sell_colorred1 = /** @type {(inputs: {}) => string} */ () => {
	return `Червено`
};
...
const sell_colorred1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_colorred1(inputs)
	return bg_sell_colorred1(inputs)
};
