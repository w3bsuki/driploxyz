...
const bg_nav_topbrands1 = /** @type {(inputs: {}) => string} */ () => {
	return `Брандове`
};

const en_nav_topbrands1 = /** @type {(inputs: {}) => string} */ () => {
	return `Top Brands`
};
...
const nav_topbrands1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_nav_topbrands1(inputs)
	return en_nav_topbrands1(inputs)
};
