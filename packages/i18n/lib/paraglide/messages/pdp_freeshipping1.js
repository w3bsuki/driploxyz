...
const bg_pdp_freeshipping1 = /** @type {(inputs: {}) => string} */ () => {
	return `Безплатна доставка`
};

const en_pdp_freeshipping1 = /** @type {(inputs: {}) => string} */ () => {
...
const pdp_freeshipping1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_pdp_freeshipping1(inputs)
	return en_pdp_freeshipping1(inputs)
};
