...
const bg_pdp_similaritems1 = /** @type {(inputs: {}) => string} */ () => {
	return `Подобни артикули`
};

const en_pdp_similaritems1 = /** @type {(inputs: {}) => string} */ () => {
...
const pdp_similaritems1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_pdp_similaritems1(inputs)
	return en_pdp_similaritems1(inputs)
};
