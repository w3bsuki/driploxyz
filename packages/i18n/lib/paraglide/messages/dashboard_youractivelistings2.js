...
const bg_dashboard_youractivelistings2 = /** @type {(inputs: {}) => string} */ () => {
	return `Вашите активни обяви`
};

const en_dashboard_youractivelistings2 = /** @type {(inputs: {}) => string} */ () => {
...
const dashboard_youractivelistings2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_dashboard_youractivelistings2(inputs)
	return en_dashboard_youractivelistings2(inputs)
};
