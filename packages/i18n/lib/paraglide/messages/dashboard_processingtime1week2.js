...
const en_dashboard_processingtime1week2 = /** @type {(inputs: {}) => string} */ () => {
	return `1 week`
};

const bg_dashboard_processingtime1week2 = /** @type {(inputs: {}) => string} */ () => {
	return `1 седмица`
};
...
const dashboard_processingtime1week2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_processingtime1week2(inputs)
	return bg_dashboard_processingtime1week2(inputs)
};
