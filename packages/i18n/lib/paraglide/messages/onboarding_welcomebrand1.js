...
const bg_onboarding_welcomebrand1 = /** @type {(inputs: {}) => string} */ () => {
	return `Добре дошли в Driplo Business! 🏢`
};

const en_onboarding_welcomebrand1 = /** @type {(inputs: {}) => string} */ () => {
	return `Welcome to Driplo Business! 🏢`
};
...
const onboarding_welcomebrand1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_onboarding_welcomebrand1(inputs)
	return en_onboarding_welcomebrand1(inputs)
};
