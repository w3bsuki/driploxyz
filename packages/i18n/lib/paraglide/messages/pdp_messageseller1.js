...
const bg_pdp_messageseller1 = /** @type {(inputs: {}) => string} */ () => {
	return `Съобщение до продавача`
};

const en_pdp_messageseller1 = /** @type {(inputs: {}) => string} */ () => {
...
const pdp_messageseller1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_pdp_messageseller1(inputs)
	return en_pdp_messageseller1(inputs)
};
