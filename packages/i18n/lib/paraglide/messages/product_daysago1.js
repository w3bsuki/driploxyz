...
const bg_product_daysago1 = /** @type {(inputs: {}) => string} */ () => {
	return `д преди`
};

const en_product_daysago1 = /** @type {(inputs: {}) => string} */ () => {
	return `d ago`
};
...
const product_daysago1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_product_daysago1(inputs)
	return en_product_daysago1(inputs)
};
