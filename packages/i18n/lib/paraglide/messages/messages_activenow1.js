...
const bg_messages_activenow1 = /** @type {(inputs: {}) => string} */ () => {
	return `Активен сега`
};

const en_messages_activenow1 = /** @type {(inputs: {}) => string} */ () => {
	return `Active now`
};
...
const messages_activenow1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_messages_activenow1(inputs)
	return en_messages_activenow1(inputs)
};
