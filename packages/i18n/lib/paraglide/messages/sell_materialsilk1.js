...
const en_sell_materialsilk1 = /** @type {(inputs: {}) => string} */ () => {
	return `Silk`
};

const bg_sell_materialsilk1 = /** @type {(inputs: {}) => string} */ () => {
	return `Коприна`
};
...
const sell_materialsilk1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_materialsilk1(inputs)
	return bg_sell_materialsilk1(inputs)
};
