...
const bg_welcome_modal_getstarted1 = /** @type {(inputs: {}) => string} */ () => {
	return `Започнете`
};

const en_welcome_modal_getstarted1 = /** @type {(inputs: {}) => string} */ () => {
	return `Get Started`
};
...
const welcome_modal_getstarted1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_welcome_modal_getstarted1(inputs)
	return en_welcome_modal_getstarted1(inputs)
};
