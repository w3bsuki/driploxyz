...
const bg_dashboard_paymentsettings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Настройки за плащане`
};

const en_dashboard_paymentsettings1 = /** @type {(inputs: {}) => string} */ () => {
...
const dashboard_paymentsettings1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_dashboard_paymentsettings1(inputs)
	return en_dashboard_paymentsettings1(inputs)
};
