...
const bg_product_soldout1 = /** @type {(inputs: {}) => string} */ () => {
	return `Продадено`
};

const en_product_soldout1 = /** @type {(inputs: {}) => string} */ () => {
	return `Sold Out`
};
...
const product_soldout1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_product_soldout1(inputs)
	return en_product_soldout1(inputs)
};
