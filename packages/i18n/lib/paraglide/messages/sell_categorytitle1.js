...
const en_sell_categorytitle1 = /** @type {(inputs: {}) => string} */ () => {
	return `Choose Category`
};

const bg_sell_categorytitle1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_categorytitle1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_categorytitle1(inputs)
	return bg_sell_categorytitle1(inputs)
};
