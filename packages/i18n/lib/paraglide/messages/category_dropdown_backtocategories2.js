...
const en_category_dropdown_backtocategories2 = /** @type {(inputs: {}) => string} */ () => {
	return `Back to Categories`
};

const bg_category_dropdown_backtocategories2 = /** @type {(inputs: {}) => string} */ () => {
	return `Назад към категории`
};
...
const category_dropdown_backtocategories2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_dropdown_backtocategories2(inputs)
	return bg_category_dropdown_backtocategories2(inputs)
};
