...
const en_sell_titlefieldlabel2 = /** @type {(inputs: {}) => string} */ () => {
	return `Title`
};

const bg_sell_titlefieldlabel2 = /** @type {(inputs: {}) => string} */ () => {
	return `Заглавие`
};
...
const sell_titlefieldlabel2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_titlefieldlabel2(inputs)
	return bg_sell_titlefieldlabel2(inputs)
};
