...
const en_dashboard_trafficsources1 = /** @type {(inputs: {}) => string} */ () => {
	return `Traffic Sources`
};

const bg_dashboard_trafficsources1 = /** @type {(inputs: {}) => string} */ () => {
	return `Източници на трафик`
};
...
const dashboard_trafficsources1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_trafficsources1(inputs)
	return bg_dashboard_trafficsources1(inputs)
};
