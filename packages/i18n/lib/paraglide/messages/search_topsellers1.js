...
const bg_search_topsellers1 = /** @type {(inputs: {}) => string} */ () => {
	return `Топ продавачи`
};

const en_search_topsellers1 = /** @type {(inputs: {}) => string} */ () => {
	return `Top Sellers`
};
...
const search_topsellers1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_search_topsellers1(inputs)
	return en_search_topsellers1(inputs)
};
