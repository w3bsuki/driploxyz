...
const bg_sell_validationerror1 = /** @type {(inputs: {}) => string} */ () => {
	return `Моля попълнете всички задължителни полета`
};

const en_sell_validationerror1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_validationerror1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_validationerror1(inputs)
	return en_sell_validationerror1(inputs)
};
