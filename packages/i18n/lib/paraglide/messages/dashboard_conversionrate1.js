...
const en_dashboard_conversionrate1 = /** @type {(inputs: {}) => string} */ () => {
	return `Conversion Rate`
};

const bg_dashboard_conversionrate1 = /** @type {(inputs: {}) => string} */ () => {
	return `Конверсия`
};
...
const dashboard_conversionrate1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_conversionrate1(inputs)
	return bg_dashboard_conversionrate1(inputs)
};
