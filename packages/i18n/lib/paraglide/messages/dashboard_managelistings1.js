...
const bg_dashboard_managelistings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Управление на обяви`
};

const en_dashboard_managelistings1 = /** @type {(inputs: {}) => string} */ () => {
...
const dashboard_managelistings1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_dashboard_managelistings1(inputs)
	return en_dashboard_managelistings1(inputs)
};
