...
const en_sell_condition_brandnewwithouttags3 = /** @type {(inputs: {}) => string} */ () => {
	return `New without tags`
};

const bg_sell_condition_brandnewwithouttags3 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_condition_brandnewwithouttags3 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_condition_brandnewwithouttags3(inputs)
	return bg_sell_condition_brandnewwithouttags3(inputs)
};
