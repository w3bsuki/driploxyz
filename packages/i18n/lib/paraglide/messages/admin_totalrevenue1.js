...
const en_admin_totalrevenue1 = /** @type {(inputs: {}) => string} */ () => {
	return `Total Revenue`
};

const bg_admin_totalrevenue1 = /** @type {(inputs: {}) => string} */ () => {
	return `Общи приходи`
};
...
const admin_totalrevenue1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_admin_totalrevenue1(inputs)
	return bg_admin_totalrevenue1(inputs)
};
