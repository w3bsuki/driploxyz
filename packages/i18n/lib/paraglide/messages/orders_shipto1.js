...
const en_orders_shipto1 = /** @type {(inputs: {}) => string} */ () => {
	return `Ship to`
};

const bg_orders_shipto1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изпрати до`
};
...
const orders_shipto1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_orders_shipto1(inputs)
	return bg_orders_shipto1(inputs)
};
