...
const en_sell_condition_fair = /** @type {(inputs: {}) => string} */ () => {
	return `Fair`
};

const bg_sell_condition_fair = /** @type {(inputs: {}) => string} */ () => {
...
export const sell_condition_fair = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_condition_fair(inputs)
	return bg_sell_condition_fair(inputs)
};