...
const en_messages_makeoffer1 = /** @type {(inputs: {}) => string} */ () => {
	return `Make Offer`
};

const bg_messages_makeoffer1 = /** @type {(inputs: {}) => string} */ () => {
...
const messages_makeoffer1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_messages_makeoffer1(inputs)
	return bg_messages_makeoffer1(inputs)
};
