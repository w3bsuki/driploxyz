...
const en_dashboard_createlisting1 = /** @type {(inputs: {}) => string} */ () => {
	return `Create Listing`
};

const bg_dashboard_createlisting1 = /** @type {(inputs: {}) => string} */ () => {
	return `Създай обява`
};
...
const dashboard_createlisting1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_createlisting1(inputs)
	return bg_dashboard_createlisting1(inputs)
};
