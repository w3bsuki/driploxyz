...
const en_sell_accessorieslist1 = /** @type {(inputs: {}) => string} */ () => {
	return `accessories list`
};

const bg_sell_accessorieslist1 = /** @type {(inputs: {}) => string} */ () => {
	return `списък с аксесоари`
};
...
const sell_accessorieslist1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_accessorieslist1(inputs)
	return bg_sell_accessorieslist1(inputs)
};
