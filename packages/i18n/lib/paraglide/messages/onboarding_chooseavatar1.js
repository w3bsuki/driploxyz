...
const bg_onboarding_chooseavatar1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изберете вашия аватар`
};

const en_onboarding_chooseavatar1 = /** @type {(inputs: {}) => string} */ () => {
...
const onboarding_chooseavatar1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_onboarding_chooseavatar1(inputs)
	return en_onboarding_chooseavatar1(inputs)
};
