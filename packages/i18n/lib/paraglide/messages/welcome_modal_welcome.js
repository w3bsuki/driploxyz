...
const bg_welcome_modal_welcome = /** @type {(inputs: {}) => string} */ () => {
	return `Добре дошли в Driplo`
};

const en_welcome_modal_welcome = /** @type {(inputs: {}) => string} */ () => {
...
export const welcome_modal_welcome = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_welcome_modal_welcome(inputs)
	return en_welcome_modal_welcome(inputs)
};