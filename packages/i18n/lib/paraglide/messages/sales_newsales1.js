...
const en_sales_newsales1 = /** @type {(inputs: {}) => string} */ () => {
	return `new`
};

const bg_sales_newsales1 = /** @type {(inputs: {}) => string} */ () => {
	return `нови`
};
...
const sales_newsales1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sales_newsales1(inputs)
	return bg_sales_newsales1(inputs)
};
