...
const bg_sell_colorblue1 = /** @type {(inputs: {}) => string} */ () => {
	return `Синьо`
};

const en_sell_colorblue1 = /** @type {(inputs: {}) => string} */ () => {
	return `Blue`
};
...
const sell_colorblue1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_colorblue1(inputs)
	return en_sell_colorblue1(inputs)
};
