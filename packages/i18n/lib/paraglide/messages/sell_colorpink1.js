...
const bg_sell_colorpink1 = /** @type {(inputs: {}) => string} */ () => {
	return `Розово`
};

const en_sell_colorpink1 = /** @type {(inputs: {}) => string} */ () => {
	return `Pink`
};
...
const sell_colorpink1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_colorpink1(inputs)
	return en_sell_colorpink1(inputs)
};
