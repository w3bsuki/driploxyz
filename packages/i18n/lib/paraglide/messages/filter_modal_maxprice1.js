...
const en_filter_modal_maxprice1 = /** @type {(inputs: {}) => string} */ () => {
	return `Max`
};

const bg_filter_modal_maxprice1 = /** @type {(inputs: {}) => string} */ () => {
	return `Макс`
};
...
const filter_modal_maxprice1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_filter_modal_maxprice1(inputs)
	return bg_filter_modal_maxprice1(inputs)
};
