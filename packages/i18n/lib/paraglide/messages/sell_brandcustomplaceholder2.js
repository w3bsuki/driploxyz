...
const bg_sell_brandcustomplaceholder2 = /** @type {(inputs: {}) => string} */ () => {
	return `Въведете марка...`
};

const en_sell_brandcustomplaceholder2 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_brandcustomplaceholder2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_brandcustomplaceholder2(inputs)
	return en_sell_brandcustomplaceholder2(inputs)
};
