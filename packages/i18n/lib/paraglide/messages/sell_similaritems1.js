...
const en_sell_similaritems1 = /** @type {(inputs: {}) => string} */ () => {
	return `Similar items`
};

const bg_sell_similaritems1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_similaritems1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_similaritems1(inputs)
	return bg_sell_similaritems1(inputs)
};
