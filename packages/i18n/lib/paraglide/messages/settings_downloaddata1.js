...
const bg_settings_downloaddata1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изтегли данните си`
};

const en_settings_downloaddata1 = /** @type {(inputs: {}) => string} */ () => {
...
const settings_downloaddata1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_settings_downloaddata1(inputs)
	return en_settings_downloaddata1(inputs)
};
