...
const bg_auth_signin1 = /** @type {(inputs: {}) => string} */ () => {
	return `Вход`
};

const en_auth_signin1 = /** @type {(inputs: {}) => string} */ () => {
	return `Sign In`
};
...
const auth_signin1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_auth_signin1(inputs)
	return en_auth_signin1(inputs)
};
