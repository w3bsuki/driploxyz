...
const en_dashboard_thismonth1 = /** @type {(inputs: {}) => string} */ () => {
	return `This month`
};

const bg_dashboard_thismonth1 = /** @type {(inputs: {}) => string} */ () => {
	return `Този месец`
};
...
const dashboard_thismonth1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_thismonth1(inputs)
	return bg_dashboard_thismonth1(inputs)
};
