...
const en_category_accessoriestype1 = /** @type {(inputs: {}) => string} */ () => {
	return `Accessories`
};

const bg_category_accessoriestype1 = /** @type {(inputs: {}) => string} */ () => {
	return `Аксесоари`
};
...
const category_accessoriestype1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_accessoriestype1(inputs)
	return bg_category_accessoriestype1(inputs)
};
