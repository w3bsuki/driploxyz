...
const bg_pdp_makeoffer1 = /** @type {(inputs: {}) => string} */ () => {
	return `Направи оферта`
};

const en_pdp_makeoffer1 = /** @type {(inputs: {}) => string} */ () => {
	return `Make Offer`
};
...
const pdp_makeoffer1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_pdp_makeoffer1(inputs)
	return en_pdp_makeoffer1(inputs)
};
