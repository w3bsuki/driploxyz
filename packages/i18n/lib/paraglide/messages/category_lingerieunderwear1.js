...
const bg_category_lingerieunderwear1 = /** @type {(inputs: {}) => string} */ () => {
	return `Дамско бельо`
};

const en_category_lingerieunderwear1 = /** @type {(inputs: {}) => string} */ () => {
	return `Lingerie & Underwear`
};
...
const category_lingerieunderwear1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_category_lingerieunderwear1(inputs)
	return en_category_lingerieunderwear1(inputs)
};
