...
const en_sell_titlelabel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Title`
};

const bg_sell_titlelabel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Заглавие`
};
...
const sell_titlelabel1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_titlelabel1(inputs)
	return bg_sell_titlelabel1(inputs)
};
