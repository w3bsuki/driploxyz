...
const en_upgrade_mostpopular1 = /** @type {(inputs: {}) => string} */ () => {
	return `Most Popular`
};

const bg_upgrade_mostpopular1 = /** @type {(inputs: {}) => string} */ () => {
	return `Най-популярен`
};
...
const upgrade_mostpopular1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_upgrade_mostpopular1(inputs)
	return bg_upgrade_mostpopular1(inputs)
};
