...
const bg_sell_descriptionoptional1 = /** @type {(inputs: {}) => string} */ () => {
	return `Описание (опционално)`
};

const en_sell_descriptionoptional1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_descriptionoptional1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_descriptionoptional1(inputs)
	return en_sell_descriptionoptional1(inputs)
};
