...
const en_dashboard_orderid1 = /** @type {(inputs: {}) => string} */ () => {
	return `Order ID`
};

const bg_dashboard_orderid1 = /** @type {(inputs: {}) => string} */ () => {
...
const dashboard_orderid1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_orderid1(inputs)
	return bg_dashboard_orderid1(inputs)
};
