...
const en_profile_membersince1 = /** @type {(inputs: {}) => string} */ () => {
	return `Member Since`
};

const bg_profile_membersince1 = /** @type {(inputs: {}) => string} */ () => {
	return `Член от`
};
...
const profile_membersince1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_profile_membersince1(inputs)
	return bg_profile_membersince1(inputs)
};
