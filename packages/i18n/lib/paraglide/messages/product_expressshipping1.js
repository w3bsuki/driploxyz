...
const en_product_expressshipping1 = /** @type {(inputs: {}) => string} */ () => {
	return `Express`
};

const bg_product_expressshipping1 = /** @type {(inputs: {}) => string} */ () => {
	return `Експресна`
};
...
const product_expressshipping1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_expressshipping1(inputs)
	return bg_product_expressshipping1(inputs)
};
