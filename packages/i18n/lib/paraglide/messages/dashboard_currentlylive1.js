...
const bg_dashboard_currentlylive1 = /** @type {(inputs: {}) => string} */ () => {
	return `Моментно активни`
};

const en_dashboard_currentlylive1 = /** @type {(inputs: {}) => string} */ () => {
...
const dashboard_currentlylive1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_dashboard_currentlylive1(inputs)
	return en_dashboard_currentlylive1(inputs)
};
