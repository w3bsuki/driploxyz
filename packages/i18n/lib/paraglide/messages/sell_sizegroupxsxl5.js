...
const en_sell_sizegroupxsxl5 = /** @type {(inputs: {}) => string} */ () => {
	return `XS-XL`
};

const bg_sell_sizegroupxsxl5 = /** @type {(inputs: {}) => string} */ () => {
	return `XS-XL`
};
...
const sell_sizegroupxsxl5 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_sizegroupxsxl5(inputs)
	return bg_sell_sizegroupxsxl5(inputs)
};
