...
const en_sell_sizeplaceholder1 = /** @type {(inputs: {}) => string} */ () => {
	return `Select size...`
};

const bg_sell_sizeplaceholder1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_sizeplaceholder1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_sizeplaceholder1(inputs)
	return bg_sell_sizeplaceholder1(inputs)
};
