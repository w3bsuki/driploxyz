...
const en_sell_choosemanually1 = /** @type {(inputs: {}) => string} */ () => {
	return `Choose Manually`
};

const bg_sell_choosemanually1 = /** @type {(inputs: {}) => string} */ () => {
	return `Избери ръчно`
};
...
const sell_choosemanually1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_choosemanually1(inputs)
	return bg_sell_choosemanually1(inputs)
};
