...
const en_banner_startselling1 = /** @type {(inputs: {}) => string} */ () => {
	return `Start Selling`
};

const bg_banner_startselling1 = /** @type {(inputs: {}) => string} */ () => {
	return `Продай`
};
...
const banner_startselling1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_banner_startselling1(inputs)
	return bg_banner_startselling1(inputs)
};
