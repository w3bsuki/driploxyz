...
const en_sell_premiumboostactive2 = /** @type {(inputs: {}) => string} */ () => {
	return `Active`
};

const bg_sell_premiumboostactive2 = /** @type {(inputs: {}) => string} */ () => {
	return `Активна`
};
...
const sell_premiumboostactive2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_premiumboostactive2(inputs)
	return bg_sell_premiumboostactive2(inputs)
};
