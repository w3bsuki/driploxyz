...
const bg_filter_sortby1 = /** @type {(inputs: {}) => string} */ () => {
	return `Сортирай по`
};

const en_filter_sortby1 = /** @type {(inputs: {}) => string} */ () => {
	return `Sort by`
};
...
const filter_sortby1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_filter_sortby1(inputs)
	return en_filter_sortby1(inputs)
};
