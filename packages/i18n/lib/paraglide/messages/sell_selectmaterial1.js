...
const en_sell_selectmaterial1 = /** @type {(inputs: {}) => string} */ () => {
	return `Select material`
};

const bg_sell_selectmaterial1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изберете материал`
};
...
const sell_selectmaterial1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_selectmaterial1(inputs)
	return bg_sell_selectmaterial1(inputs)
};
