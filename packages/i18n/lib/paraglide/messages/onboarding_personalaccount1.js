...
const en_onboarding_personalaccount1 = /** @type {(inputs: {}) => string} */ () => {
	return `Personal Account`
};

const bg_onboarding_personalaccount1 = /** @type {(inputs: {}) => string} */ () => {
	return `Личен акаунт`
};
...
const onboarding_personalaccount1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_onboarding_personalaccount1(inputs)
	return bg_onboarding_personalaccount1(inputs)
};
