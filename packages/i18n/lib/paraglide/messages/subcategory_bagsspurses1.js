...
/** @type {(inputs: {}) => string} */
const en_subcategory_bagsspurses1 = () => 'subcategory_bagssPurses'
...
const subcategory_bagsspurses1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_subcategory_bagsspurses1(inputs)
	return bg_subcategory_bagsspurses1(inputs)
};
