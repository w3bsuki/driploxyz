...
const bg_subcategory_bagsspurses1 = /** @type {(inputs: {}) => string} */ () => {
	return `Чанти`
};

/** @type {(inputs: {}) => string} */
const en_subcategory_bagsspurses1 = bg_subcategory_bagsspurses1;
...
const subcategory_bagsspurses1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_subcategory_bagsspurses1(inputs)
	return en_subcategory_bagsspurses1(inputs)
};
