...
const en_admin_managepayouts1 = /** @type {(inputs: {}) => string} */ () => {
	return `Manage Payouts`
};

const bg_admin_managepayouts1 = /** @type {(inputs: {}) => string} */ () => {
...
const admin_managepayouts1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_admin_managepayouts1(inputs)
	return bg_admin_managepayouts1(inputs)
};
