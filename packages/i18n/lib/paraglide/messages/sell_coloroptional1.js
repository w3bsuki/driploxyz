...
const bg_sell_coloroptional1 = /** @type {(inputs: {}) => string} */ () => {
	return `(по избор)`
};

const en_sell_coloroptional1 = /** @type {(inputs: {}) => string} */ () => {
	return `(optional)`
};
...
const sell_coloroptional1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_coloroptional1(inputs)
	return en_sell_coloroptional1(inputs)
};
