...
const bg_category_topstshirts1 = /** @type {(inputs: {}) => string} */ () => {
	return `Топове и тениски`
};

const en_category_topstshirts1 = /** @type {(inputs: {}) => string} */ () => {
...
const category_topstshirts1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_category_topstshirts1(inputs)
	return en_category_topstshirts1(inputs)
};
