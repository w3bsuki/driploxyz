...
const en_product_shippingreturns1 = /** @type {(inputs: {}) => string} */ () => {
	return `Shipping & Returns`
};

const bg_product_shippingreturns1 = /** @type {(inputs: {}) => string} */ () => {
	return `Доставка и връщания`
};
...
const product_shippingreturns1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_shippingreturns1(inputs)
	return bg_product_shippingreturns1(inputs)
};
