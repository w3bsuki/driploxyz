...
const en_category_travelbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Travel Bags`
};

const bg_category_travelbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Пътни чанти`
};
...
const category_travelbags1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_travelbags1(inputs)
	return bg_category_travelbags1(inputs)
};
