...
const bg_checkout_completepurchasebutton2 = /** @type {(inputs: {}) => string} */ () => {
	return `Завърши покупката`
};

const en_checkout_completepurchasebutton2 = /** @type {(inputs: {}) => string} */ () => {
...
const checkout_completepurchasebutton2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_checkout_completepurchasebutton2(inputs)
	return en_checkout_completepurchasebutton2(inputs)
};
