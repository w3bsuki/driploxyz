...
const bg_banner_firstmonth1 = /** @type {(inputs: {}) => string} */ () => {
	return `Първи месец`
};

const en_banner_firstmonth1 = /** @type {(inputs: {}) => string} */ () => {
	return `First Month`
};
...
const banner_firstmonth1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_banner_firstmonth1(inputs)
	return en_banner_firstmonth1(inputs)
};
