...
const bg_sell_categorylabel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Категория`
};

const en_sell_categorylabel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Category`
};
...
const sell_categorylabel1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_categorylabel1(inputs)
	return en_sell_categorylabel1(inputs)
};
