...
const bg_sell_condition_likenew_desc1 = /** @type {(inputs: {}) => string} */ () => {
	return `Носено 1-2 пъти`
};

const en_sell_condition_likenew_desc1 = /** @type {(inputs: {}) => string} */ () => {
	return `Worn 1-2x`
};
...
const sell_condition_likenew_desc1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_condition_likenew_desc1(inputs)
	return en_sell_condition_likenew_desc1(inputs)
};
