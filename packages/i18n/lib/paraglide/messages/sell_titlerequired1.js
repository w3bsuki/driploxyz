...
const bg_sell_titlerequired1 = /** @type {(inputs: {}) => string} */ () => {
	return `Заглавието е задължително`
};

const en_sell_titlerequired1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_titlerequired1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_titlerequired1(inputs)
	return en_sell_titlerequired1(inputs)
};
