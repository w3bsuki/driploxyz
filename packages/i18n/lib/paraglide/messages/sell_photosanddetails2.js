...
const en_sell_photosanddetails2 = /** @type {(inputs: {}) => string} */ () => {
	return `Photos & Details`
};

const bg_sell_photosanddetails2 = /** @type {(inputs: {}) => string} */ () => {
	return `Снимки и детайли`
};
...
const sell_photosanddetails2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_photosanddetails2(inputs)
	return bg_sell_photosanddetails2(inputs)
};
