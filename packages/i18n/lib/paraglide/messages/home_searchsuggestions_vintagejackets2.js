...
const en_home_searchsuggestions_vintagejackets2 = /** @type {(inputs: {}) => string} */ () => {
	return `Vintage jackets`
};

const bg_home_searchsuggestions_vintagejackets2 = /** @type {(inputs: {}) => string} */ () => {
...
const home_searchsuggestions_vintagejackets2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_home_searchsuggestions_vintagejackets2(inputs)
	return bg_home_searchsuggestions_vintagejackets2(inputs)
};
