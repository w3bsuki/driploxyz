...
const bg_nav_languagetheme1 = /** @type {(inputs: {}) => string} */ () => {
	return `Език и тема`
};

const en_nav_languagetheme1 = /** @type {(inputs: {}) => string} */ () => {
...
const nav_languagetheme1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_nav_languagetheme1(inputs)
	return en_nav_languagetheme1(inputs)
};
