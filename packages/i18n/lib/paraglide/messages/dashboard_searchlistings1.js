...
const en_dashboard_searchlistings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Search listings...`
};

const bg_dashboard_searchlistings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Търси обяви...`
};
...
const dashboard_searchlistings1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_searchlistings1(inputs)
	return bg_dashboard_searchlistings1(inputs)
};
