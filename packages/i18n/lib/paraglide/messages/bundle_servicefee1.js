...
const en_bundle_servicefee1 = /** @type {(inputs: {}) => string} */ () => {
	return `Service fee`
};

const bg_bundle_servicefee1 = /** @type {(inputs: {}) => string} */ () => {
...
const bundle_servicefee1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_bundle_servicefee1(inputs)
	return bg_bundle_servicefee1(inputs)
};
