...
const bg_pdp_nothelpful1 = /** @type {(inputs: {}) => string} */ () => {
	return `Неполезно`
};

const en_pdp_nothelpful1 = /** @type {(inputs: {}) => string} */ () => {
	return `Not Helpful`
};
...
const pdp_nothelpful1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_pdp_nothelpful1(inputs)
	return en_pdp_nothelpful1(inputs)
};
