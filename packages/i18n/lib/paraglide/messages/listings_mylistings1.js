...
const en_listings_mylistings1 = /** @type {(inputs: {}) => string} */ () => {
	return `My Listings`
};

const bg_listings_mylistings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Моите обяви`
};
...
const listings_mylistings1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_listings_mylistings1(inputs)
	return bg_listings_mylistings1(inputs)
};
