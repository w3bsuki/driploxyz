...
const bg_welcome_modal_totalsales1 = /** @type {(inputs: {}) => string} */ () => {
	return `Общи Продажби`
};

const en_welcome_modal_totalsales1 = /** @type {(inputs: {}) => string} */ () => {
	return `Total Sales`
};
...
const welcome_modal_totalsales1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_welcome_modal_totalsales1(inputs)
	return en_welcome_modal_totalsales1(inputs)
};
