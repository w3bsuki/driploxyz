...
const bg_dashboard_totalearned1 = /** @type {(inputs: {}) => string} */ () => {
	return `Общо спечелено`
};

const en_dashboard_totalearned1 = /** @type {(inputs: {}) => string} */ () => {
	return `Total earned`
};
...
const dashboard_totalearned1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_dashboard_totalearned1(inputs)
	return en_dashboard_totalearned1(inputs)
};
