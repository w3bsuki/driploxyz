...
const en_sell_whoisthisfor3 = /** @type {(inputs: {}) => string} */ () => {
	return `Who is this for?`
};

const bg_sell_whoisthisfor3 = /** @type {(inputs: {}) => string} */ () => {
	return `За кого е?`
};
...
const sell_whoisthisfor3 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_whoisthisfor3(inputs)
	return bg_sell_whoisthisfor3(inputs)
};
