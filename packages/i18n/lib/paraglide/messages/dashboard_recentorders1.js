...
const en_dashboard_recentorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `Recent Orders`
};

const bg_dashboard_recentorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `Последни поръчки`
};
...
const dashboard_recentorders1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_recentorders1(inputs)
	return bg_dashboard_recentorders1(inputs)
};
