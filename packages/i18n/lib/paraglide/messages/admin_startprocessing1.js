...
const bg_admin_startprocessing1 = /** @type {(inputs: {}) => string} */ () => {
	return `Започни обработка`
};

const en_admin_startprocessing1 = /** @type {(inputs: {}) => string} */ () => {
...
const admin_startprocessing1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_admin_startprocessing1(inputs)
	return en_admin_startprocessing1(inputs)
};
