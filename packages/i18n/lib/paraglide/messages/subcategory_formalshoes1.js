...
/** @type {(inputs: {}) => string} */
const en_subcategory_formalshoes1 = bg_subcategory_formalshoes1;
...
const subcategory_formalshoes1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_subcategory_formalshoes1(inputs)
	return en_subcategory_formalshoes1(inputs)
};
