...
const bg_dashboard_allorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `Всички поръчки`
};

const en_dashboard_allorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `All Orders`
};
...
const dashboard_allorders1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_dashboard_allorders1(inputs)
	return en_dashboard_allorders1(inputs)
};
