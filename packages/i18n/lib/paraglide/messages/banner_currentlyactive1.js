...
const en_banner_currentlyactive1 = /** @type {(inputs: {}) => string} */ () => {
	return `Currently Active`
};

const bg_banner_currentlyactive1 = /** @type {(inputs: {}) => string} */ () => {
	return `В момента активен`
};
...
const banner_currentlyactive1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_banner_currentlyactive1(inputs)
	return bg_banner_currentlyactive1(inputs)
};
