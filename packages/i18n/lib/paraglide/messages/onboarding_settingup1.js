...
const bg_onboarding_settingup1 = /** @type {(inputs: {}) => string} */ () => {
	return `Настройване...`
};

const en_onboarding_settingup1 = /** @type {(inputs: {}) => string} */ () => {
	return `Setting up...`
};
...
const onboarding_settingup1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_onboarding_settingup1(inputs)
	return en_onboarding_settingup1(inputs)
};
