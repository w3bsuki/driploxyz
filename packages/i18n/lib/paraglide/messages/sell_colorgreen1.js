...
const bg_sell_colorgreen1 = /** @type {(inputs: {}) => string} */ () => {
	return `Зелено`
};

const en_sell_colorgreen1 = /** @type {(inputs: {}) => string} */ () => {
	return `Green`
};
...
const sell_colorgreen1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_colorgreen1(inputs)
	return en_sell_colorgreen1(inputs)
};
