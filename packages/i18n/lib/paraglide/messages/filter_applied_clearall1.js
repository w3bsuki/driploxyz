...
const en_filter_applied_clearall1 = /** @type {(inputs: {}) => string} */ () => {
	return `Clear all`
};

const bg_filter_applied_clearall1 = /** @type {(inputs: {}) => string} */ () => {
...
const filter_applied_clearall1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_filter_applied_clearall1(inputs)
	return bg_filter_applied_clearall1(inputs)
};
