...
const en_seller_premiumseller1 = /** @type {(inputs: {}) => string} */ () => {
	return `Premium Seller`
};

const bg_seller_premiumseller1 = /** @type {(inputs: {}) => string} */ () => {
	return `Премиум`
};
...
const seller_premiumseller1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_seller_premiumseller1(inputs)
	return bg_seller_premiumseller1(inputs)
};
