...
const en_bundle_shiptogether1 = /** @type {(inputs: {}) => string} */ () => {
	return `Ship together`
};

const bg_bundle_shiptogether1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изпращане заедно`
};
...
const bundle_shiptogether1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_bundle_shiptogether1(inputs)
	return bg_bundle_shiptogether1(inputs)
};
