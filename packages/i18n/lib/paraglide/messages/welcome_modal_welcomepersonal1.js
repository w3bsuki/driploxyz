...
const bg_welcome_modal_welcomepersonal1 = /** @type {(inputs: {}) => string} */ () => {
	return `Добре дошли в Driplo! 🎉`
};

const en_welcome_modal_welcomepersonal1 = /** @type {(inputs: {}) => string} */ () => {
	return `Welcome`
};
...
const welcome_modal_welcomepersonal1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_welcome_modal_welcomepersonal1(inputs)
	return en_welcome_modal_welcomepersonal1(inputs)
};
