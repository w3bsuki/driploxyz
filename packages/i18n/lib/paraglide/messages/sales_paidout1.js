...
const en_sales_paidout1 = /** @type {(inputs: {}) => string} */ () => {
	return `Paid Out`
};

const bg_sales_paidout1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изплатено`
};
...
const sales_paidout1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sales_paidout1(inputs)
	return bg_sales_paidout1(inputs)
};
