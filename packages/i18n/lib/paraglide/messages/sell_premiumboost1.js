...
const bg_sell_premiumboost1 = /** @type {(inputs: {}) => string} */ () => {
	return `Премиум промоция`
};

const en_sell_premiumboost1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_premiumboost1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_premiumboost1(inputs)
	return en_sell_premiumboost1(inputs)
};
