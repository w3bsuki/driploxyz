...
const bg_home_trending_y2kjeans1 = /** @type {(inputs: {}) => string} */ () => {
	return `Y2K дънки`
};

const en_home_trending_y2kjeans1 = /** @type {(inputs: {}) => string} */ () => {
	return `Y2K jeans`
};
...
const home_trending_y2kjeans1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_home_trending_y2kjeans1(inputs)
	return en_home_trending_y2kjeans1(inputs)
};
