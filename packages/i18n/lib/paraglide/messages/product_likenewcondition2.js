...
const en_product_likenewcondition2 = /** @type {(inputs: {}) => string} */ () => {
	return `Like new`
};

const bg_product_likenewcondition2 = /** @type {(inputs: {}) => string} */ () => {
	return `Като нов`
};
...
const product_likenewcondition2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_likenewcondition2(inputs)
	return bg_product_likenewcondition2(inputs)
};
