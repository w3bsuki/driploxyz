...
const bg_onboarding_tutorial_welcometitle1 = /** @type {(inputs: {}) => string} */ () => {
	return `Добре дошли в Driplo! 👋`
};

const en_onboarding_tutorial_welcometitle1 = /** @type {(inputs: {}) => string} */ () => {
...
const onboarding_tutorial_welcometitle1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_onboarding_tutorial_welcometitle1(inputs)
	return en_onboarding_tutorial_welcometitle1(inputs)
};
