...
const en_filter_bestrated1 = /** @type {(inputs: {}) => string} */ () => {
	return `Best Rated`
};

const bg_filter_bestrated1 = /** @type {(inputs: {}) => string} */ () => {
...
const filter_bestrated1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_filter_bestrated1(inputs)
	return bg_filter_bestrated1(inputs)
};
