...
const en_pdp_a11y_gallerynext1 = /** @type {(inputs: {}) => string} */ () => {
	return `Next image`
};

const bg_pdp_a11y_gallerynext1 = /** @type {(inputs: {}) => string} */ () => {
	return `Следваща снимка`
};
...
const pdp_a11y_gallerynext1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_pdp_a11y_gallerynext1(inputs)
	return bg_pdp_a11y_gallerynext1(inputs)
};
