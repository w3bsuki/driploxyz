...
const bg_onboarding_tutorial_listitemtitle2 = /** @type {(inputs: {}) => string} */ () => {
	return `Качете първия си артикул`
};

const en_onboarding_tutorial_listitemtitle2 = /** @type {(inputs: {}) => string} */ () => {
...
const onboarding_tutorial_listitemtitle2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_onboarding_tutorial_listitemtitle2(inputs)
	return en_onboarding_tutorial_listitemtitle2(inputs)
};
