...
const bg_dashboard_savesettings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Запази настройки`
};

const en_dashboard_savesettings1 = /** @type {(inputs: {}) => string} */ () => {
...
const dashboard_savesettings1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_dashboard_savesettings1(inputs)
	return en_dashboard_savesettings1(inputs)
};
