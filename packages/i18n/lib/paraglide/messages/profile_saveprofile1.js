...
const bg_profile_saveprofile1 = /** @type {(inputs: {}) => string} */ () => {
	return `Запази профил`
};

const en_profile_saveprofile1 = /** @type {(inputs: {}) => string} */ () => {
	return `Save Profile`
};
...
const profile_saveprofile1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_profile_saveprofile1(inputs)
	return en_profile_saveprofile1(inputs)
};
