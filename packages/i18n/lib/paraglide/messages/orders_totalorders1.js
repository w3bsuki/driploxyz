...
const bg_orders_totalorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `Общо поръчки`
};

const en_orders_totalorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `Total Orders`
};
...
const orders_totalorders1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_orders_totalorders1(inputs)
	return en_orders_totalorders1(inputs)
};
