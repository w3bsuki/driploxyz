...
const en_category_jacketscoats1 = /** @type {(inputs: {}) => string} */ () => {
	return `Jackets & Coats`
};

const bg_category_jacketscoats1 = /** @type {(inputs: {}) => string} */ () => {
...
const category_jacketscoats1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_jacketscoats1(inputs)
	return bg_category_jacketscoats1(inputs)
};
