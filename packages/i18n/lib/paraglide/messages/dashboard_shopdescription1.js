...
const en_dashboard_shopdescription1 = /** @type {(inputs: {}) => string} */ () => {
	return `Shop Description`
};

const bg_dashboard_shopdescription1 = /** @type {(inputs: {}) => string} */ () => {
	return `Описание на магазин`
};
...
const dashboard_shopdescription1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_shopdescription1(inputs)
	return bg_dashboard_shopdescription1(inputs)
};
