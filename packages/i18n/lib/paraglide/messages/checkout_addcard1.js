...
const en_checkout_addcard1 = /** @type {(inputs: {}) => string} */ () => {
	return `Add card`
};

const bg_checkout_addcard1 = /** @type {(inputs: {}) => string} */ () => {
	return `Добави карта`
};
...
const checkout_addcard1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_checkout_addcard1(inputs)
	return bg_checkout_addcard1(inputs)
};
