...
const bg_footer_newsletterplaceholder1 = /** @type {(inputs: {}) => string} */ () => {
	return `Въведете имейла си`
};

const en_footer_newsletterplaceholder1 = /** @type {(inputs: {}) => string} */ () => {
...
const footer_newsletterplaceholder1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_footer_newsletterplaceholder1(inputs)
	return en_footer_newsletterplaceholder1(inputs)
};
