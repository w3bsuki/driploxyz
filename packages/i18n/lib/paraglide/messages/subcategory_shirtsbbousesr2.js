...
/** @type {(inputs: {}) => string} */
const en_subcategory_shirtsbbousesr2 = bg_subcategory_shirtsbbousesr2;
...
const subcategory_shirtsbbousesr2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_subcategory_shirtsbbousesr2(inputs)
	return en_subcategory_shirtsbbousesr2(inputs)
};
