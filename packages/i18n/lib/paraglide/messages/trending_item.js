...
const en_trending_item = /** @type {(inputs: {}) => string} */ () => {
	return `Trending Item`
};

/** @type {(inputs: {}) => string} */
const bg_trending_item = en_trending_item;
...
export const trending_item = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_trending_item(inputs)
	return bg_trending_item(inputs)
};