...
const bg_pdp_addtocart2 = /** @type {(inputs: {}) => string} */ () => {
	return `Добави в количката`
};

const en_pdp_addtocart2 = /** @type {(inputs: {}) => string} */ () => {
	return `Add to Cart`
};
...
const pdp_addtocart2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_pdp_addtocart2(inputs)
	return en_pdp_addtocart2(inputs)
};
