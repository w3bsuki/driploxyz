...
const bg_sales_nochange1 = /** @type {(inputs: {}) => string} */ () => {
	return `Няма промяна`
};

const en_sales_nochange1 = /** @type {(inputs: {}) => string} */ () => {
	return `No change`
};
...
const sales_nochange1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sales_nochange1(inputs)
	return en_sales_nochange1(inputs)
};
