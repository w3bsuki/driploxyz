...
const bg_sell_sizegroupukeu5 = /** @type {(inputs: {}) => string} */ () => {
	return `UK/EU`
};

const en_sell_sizegroupukeu5 = /** @type {(inputs: {}) => string} */ () => {
	return `UK/EU`
};
...
const sell_sizegroupukeu5 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_sizegroupukeu5(inputs)
	return en_sell_sizegroupukeu5(inputs)
};
