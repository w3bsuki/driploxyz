...
const bg_orders_itemstoship2 = /** @type {(inputs: {}) => string} */ () => {
	return `Артикули за изпращане`
};

const en_orders_itemstoship2 = /** @type {(inputs: {}) => string} */ () => {
...
const orders_itemstoship2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_orders_itemstoship2(inputs)
	return en_orders_itemstoship2(inputs)
};
