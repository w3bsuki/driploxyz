...
const en_pdp_justnow1 = /** @type {(inputs: {}) => string} */ () => {
	return `just now`
};

const bg_pdp_justnow1 = /** @type {(inputs: {}) => string} */ () => {
	return `току-що`
};
...
const pdp_justnow1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_pdp_justnow1(inputs)
	return bg_pdp_justnow1(inputs)
};
