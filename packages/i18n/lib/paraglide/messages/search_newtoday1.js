...
const en_search_newtoday1 = /** @type {(inputs: {}) => string} */ () => {
	return `New Today`
};

const bg_search_newtoday1 = /** @type {(inputs: {}) => string} */ () => {
	return `Нови днес`
};
...
const search_newtoday1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_search_newtoday1(inputs)
	return bg_search_newtoday1(inputs)
};
