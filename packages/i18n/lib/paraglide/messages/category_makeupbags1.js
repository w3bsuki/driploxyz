...
const bg_category_makeupbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Несесери`
};

const en_category_makeupbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Makeup Bags`
};
...
const category_makeupbags1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_category_makeupbags1(inputs)
	return en_category_makeupbags1(inputs)
};
