...
const bg_sell_selectgenderage2 = /** @type {(inputs: {}) => string} */ () => {
	return `Изберете пол/възраст`
};

const en_sell_selectgenderage2 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_selectgenderage2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_selectgenderage2(inputs)
	return en_sell_selectgenderage2(inputs)
};
