...
const bg_product_shippingtimes1 = /** @type {(inputs: {}) => string} */ () => {
	return `Време за доставка`
};

const en_product_shippingtimes1 = /** @type {(inputs: {}) => string} */ () => {
...
const product_shippingtimes1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_product_shippingtimes1(inputs)
	return en_product_shippingtimes1(inputs)
};
