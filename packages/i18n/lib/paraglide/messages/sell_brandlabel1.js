...
const en_sell_brandlabel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Brand`
};

const bg_sell_brandlabel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Марка`
};
...
const sell_brandlabel1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_brandlabel1(inputs)
	return bg_sell_brandlabel1(inputs)
};
