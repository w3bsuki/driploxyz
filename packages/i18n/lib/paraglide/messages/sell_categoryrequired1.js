...
const bg_sell_categoryrequired1 = /** @type {(inputs: {}) => string} */ () => {
	return `Категорията е задължителна`
};

const en_sell_categoryrequired1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_categoryrequired1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_categoryrequired1(inputs)
	return en_sell_categoryrequired1(inputs)
};
