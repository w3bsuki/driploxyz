...
const en_sell_specificcategorylabel2 = /** @type {(inputs: {}) => string} */ () => {
	return `Specific category`
};

const bg_sell_specificcategorylabel2 = /** @type {(inputs: {}) => string} */ () => {
	return `Конкретна категория`
};
...
const sell_specificcategorylabel2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_specificcategorylabel2(inputs)
	return bg_sell_specificcategorylabel2(inputs)
};
