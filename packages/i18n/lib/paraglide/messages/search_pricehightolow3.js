...
const en_search_pricehightolow3 = /** @type {(inputs: {}) => string} */ () => {
	return `Price: High to Low`
};

const bg_search_pricehightolow3 = /** @type {(inputs: {}) => string} */ () => {
	return `Цена ↓`
};
...
const search_pricehightolow3 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_search_pricehightolow3(inputs)
	return bg_search_pricehightolow3(inputs)
};
