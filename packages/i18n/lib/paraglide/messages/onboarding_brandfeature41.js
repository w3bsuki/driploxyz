...
const en_onboarding_brandfeature41 = /** @type {(inputs: {}) => string} */ () => {
	return `Verification badge`
};

const bg_onboarding_brandfeature41 = /** @type {(inputs: {}) => string} */ () => {
	return `Персонализиран брандинг`
};
...
const onboarding_brandfeature41 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_onboarding_brandfeature41(inputs)
	return bg_onboarding_brandfeature41(inputs)
};
