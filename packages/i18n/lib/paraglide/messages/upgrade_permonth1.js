...
const en_upgrade_permonth1 = /** @type {(inputs: {}) => string} */ () => {
	return `/ month`
};

const bg_upgrade_permonth1 = /** @type {(inputs: {}) => string} */ () => {
	return `/ месец`
};
...
const upgrade_permonth1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_upgrade_permonth1(inputs)
	return bg_upgrade_permonth1(inputs)
};
