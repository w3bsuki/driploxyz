...
const en_sell_typecategoryplaceholder2 = /** @type {(inputs: {}) => string} */ () => {
	return `Type category...`
};

const bg_sell_typecategoryplaceholder2 = /** @type {(inputs: {}) => string} */ () => {
	return `Въведи категория...`
};
...
const sell_typecategoryplaceholder2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_typecategoryplaceholder2(inputs)
	return bg_sell_typecategoryplaceholder2(inputs)
};
