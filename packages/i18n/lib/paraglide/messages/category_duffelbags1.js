...
const en_category_duffelbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Duffel Bags`
};

const bg_category_duffelbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Сакове`
};
...
const category_duffelbags1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_duffelbags1(inputs)
	return bg_category_duffelbags1(inputs)
};
