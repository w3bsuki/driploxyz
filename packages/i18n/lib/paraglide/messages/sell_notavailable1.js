...
const en_sell_notavailable1 = /** @type {(inputs: {}) => string} */ () => {
	return `N/A`
};

const bg_sell_notavailable1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_notavailable1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_notavailable1(inputs)
	return bg_sell_notavailable1(inputs)
};
