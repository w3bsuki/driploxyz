...
const bg_category_suitsblazers1 = /** @type {(inputs: {}) => string} */ () => {
	return `Костюми и сака`
};

const en_category_suitsblazers1 = /** @type {(inputs: {}) => string} */ () => {
...
const category_suitsblazers1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_category_suitsblazers1(inputs)
	return en_category_suitsblazers1(inputs)
};
