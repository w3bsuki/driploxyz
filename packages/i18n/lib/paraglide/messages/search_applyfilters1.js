...
const en_search_applyfilters1 = /** @type {(inputs: {}) => string} */ () => {
	return `Apply Filters`
};

const bg_search_applyfilters1 = /** @type {(inputs: {}) => string} */ () => {
...
const search_applyfilters1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_search_applyfilters1(inputs)
	return bg_search_applyfilters1(inputs)
};
