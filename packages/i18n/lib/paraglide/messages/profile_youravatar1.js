...
const en_profile_youravatar1 = /** @type {(inputs: {}) => string} */ () => {
	return `Your Avatar`
};

const bg_profile_youravatar1 = /** @type {(inputs: {}) => string} */ () => {
	return `Вашият аватар`
};
...
const profile_youravatar1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_profile_youravatar1(inputs)
	return bg_profile_youravatar1(inputs)
};
