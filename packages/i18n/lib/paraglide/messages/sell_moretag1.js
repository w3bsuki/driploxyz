...
const en_sell_moretag1 = /** @type {(inputs: {}) => string} */ () => {
	return `more`
};

const bg_sell_moretag1 = /** @type {(inputs: {}) => string} */ () => {
	return `още`
};
...
const sell_moretag1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_moretag1(inputs)
	return bg_sell_moretag1(inputs)
};
