...
const en_category_messengerbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Messenger Bags`
};

const bg_category_messengerbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Чанти за документи`
};
...
const category_messengerbags1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_messengerbags1(inputs)
	return bg_category_messengerbags1(inputs)
};
