...
const en_product_makeoffer1 = /** @type {(inputs: {}) => string} */ () => {
	return `Make an offer`
};

const bg_product_makeoffer1 = /** @type {(inputs: {}) => string} */ () => {
	return `Оферта`
};
...
const product_makeoffer1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_makeoffer1(inputs)
	return bg_product_makeoffer1(inputs)
};
