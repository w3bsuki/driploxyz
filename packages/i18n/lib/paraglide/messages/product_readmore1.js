...
const bg_product_readmore1 = /** @type {(inputs: {}) => string} */ () => {
	return `Виж още`
};

const en_product_readmore1 = /** @type {(inputs: {}) => string} */ () => {
	return `Read more`
};
...
const product_readmore1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_product_readmore1(inputs)
	return en_product_readmore1(inputs)
};
