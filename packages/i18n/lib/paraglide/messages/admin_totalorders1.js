...
const bg_admin_totalorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `Общо поръчки`
};

const en_admin_totalorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `Total Orders`
};
...
const admin_totalorders1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_admin_totalorders1(inputs)
	return en_admin_totalorders1(inputs)
};
