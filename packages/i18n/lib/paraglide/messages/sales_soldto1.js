...
const bg_sales_soldto1 = /** @type {(inputs: {}) => string} */ () => {
	return `Продаден на`
};

const en_sales_soldto1 = /** @type {(inputs: {}) => string} */ () => {
	return `Sold to`
};
...
const sales_soldto1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sales_soldto1(inputs)
	return en_sales_soldto1(inputs)
};
