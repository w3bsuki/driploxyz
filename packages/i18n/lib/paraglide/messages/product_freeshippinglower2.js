...
const en_product_freeshippinglower2 = /** @type {(inputs: {}) => string} */ () => {
	return `Free`
};

const bg_product_freeshippinglower2 = /** @type {(inputs: {}) => string} */ () => {
	return `Безплатно`
};
...
const product_freeshippinglower2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_freeshippinglower2(inputs)
	return bg_product_freeshippinglower2(inputs)
};
