...
const en_upgrade_chooseplan1 = /** @type {(inputs: {}) => string} */ () => {
	return `Choose Plan`
};

const bg_upgrade_chooseplan1 = /** @type {(inputs: {}) => string} */ () => {
...
const upgrade_chooseplan1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_upgrade_chooseplan1(inputs)
	return bg_upgrade_chooseplan1(inputs)
};
