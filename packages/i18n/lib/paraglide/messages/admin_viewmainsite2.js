...
const en_admin_viewmainsite2 = /** @type {(inputs: {}) => string} */ () => {
	return `View Main Site`
};

const bg_admin_viewmainsite2 = /** @type {(inputs: {}) => string} */ () => {
	return `Виж основния сайт`
};
...
const admin_viewmainsite2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_admin_viewmainsite2(inputs)
	return bg_admin_viewmainsite2(inputs)
};
