...
const bg_orders_statuspaid1 = /** @type {(inputs: {}) => string} */ () => {
	return `Платено`
};

const en_orders_statuspaid1 = /** @type {(inputs: {}) => string} */ () => {
	return `Paid`
};
...
const orders_statuspaid1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_orders_statuspaid1(inputs)
	return en_orders_statuspaid1(inputs)
};
