...
const en_category_itemscount1 = /** @type {(inputs: {}) => string} */ () => {
	return `items`
};

const bg_category_itemscount1 = /** @type {(inputs: {}) => string} */ () => {
	return `артикула`
};
...
const category_itemscount1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_itemscount1(inputs)
	return bg_category_itemscount1(inputs)
};
