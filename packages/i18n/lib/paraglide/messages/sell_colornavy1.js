...
const bg_sell_colornavy1 = /** @type {(inputs: {}) => string} */ () => {
	return `Тъмносиньо`
};

const en_sell_colornavy1 = /** @type {(inputs: {}) => string} */ () => {
	return `Navy`
};
...
const sell_colornavy1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_colornavy1(inputs)
	return en_sell_colornavy1(inputs)
};
