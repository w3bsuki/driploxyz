...
const bg_sell_colorblack1 = /** @type {(inputs: {}) => string} */ () => {
	return `Черно`
};

const en_sell_colorblack1 = /** @type {(inputs: {}) => string} */ () => {
	return `Black`
};
...
const sell_colorblack1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_colorblack1(inputs)
	return en_sell_colorblack1(inputs)
};
