...
const en_sales_averageorder1 = /** @type {(inputs: {}) => string} */ () => {
	return `Average Order`
};

const bg_sales_averageorder1 = /** @type {(inputs: {}) => string} */ () => {
	return `Средна поръчка`
};
...
const sales_averageorder1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sales_averageorder1(inputs)
	return bg_sales_averageorder1(inputs)
};
