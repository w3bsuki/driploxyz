...
const bg_category_shirtsblouses1 = /** @type {(inputs: {}) => string} */ () => {
	return `Ризи и блузи`
};

const en_category_shirtsblouses1 = /** @type {(inputs: {}) => string} */ () => {
...
const category_shirtsblouses1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_category_shirtsblouses1(inputs)
	return en_category_shirtsblouses1(inputs)
};
