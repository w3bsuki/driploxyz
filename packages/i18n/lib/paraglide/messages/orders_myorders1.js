...
const bg_orders_myorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `Поръчки`
};

const en_orders_myorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `Orders`
};
...
const orders_myorders1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_orders_myorders1(inputs)
	return en_orders_myorders1(inputs)
};
