...
const bg_category_clearall1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изчисти всички`
};

const en_category_clearall1 = /** @type {(inputs: {}) => string} */ () => {
	return `Clear all`
};
...
const category_clearall1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_category_clearall1(inputs)
	return en_category_clearall1(inputs)
};
