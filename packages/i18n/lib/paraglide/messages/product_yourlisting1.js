...
const bg_product_yourlisting1 = /** @type {(inputs: {}) => string} */ () => {
	return `Това е вашата обява`
};

const en_product_yourlisting1 = /** @type {(inputs: {}) => string} */ () => {
...
const product_yourlisting1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_product_yourlisting1(inputs)
	return en_product_yourlisting1(inputs)
};
