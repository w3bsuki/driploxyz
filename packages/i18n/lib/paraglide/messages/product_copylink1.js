...
const bg_product_copylink1 = /** @type {(inputs: {}) => string} */ () => {
	return `Линкът е копиран!`
};

const en_product_copylink1 = /** @type {(inputs: {}) => string} */ () => {
	return `Link copied!`
};
...
const product_copylink1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_product_copylink1(inputs)
	return en_product_copylink1(inputs)
};
