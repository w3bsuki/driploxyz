...
const en_dashboard_vacationmode1 = /** @type {(inputs: {}) => string} */ () => {
	return `Vacation Mode`
};

const bg_dashboard_vacationmode1 = /** @type {(inputs: {}) => string} */ () => {
	return `Ваканционен режим`
};
...
const dashboard_vacationmode1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_vacationmode1(inputs)
	return bg_dashboard_vacationmode1(inputs)
};
