...
const en_sell_descriptionrequired1 = /** @type {(inputs: {}) => string} */ () => {
	return `Description is required`
};

const bg_sell_descriptionrequired1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_descriptionrequired1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_descriptionrequired1(inputs)
	return bg_sell_descriptionrequired1(inputs)
};
