...
const bg_search_viewall1 = /** @type {(inputs: {}) => string} */ () => {
	return `Виж всички`
};

const en_search_viewall1 = /** @type {(inputs: {}) => string} */ () => {
	return `View All`
};
...
const search_viewall1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_search_viewall1(inputs)
	return en_search_viewall1(inputs)
};
