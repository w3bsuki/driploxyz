...
const en_seller_activenow1 = /** @type {(inputs: {}) => string} */ () => {
	return `Active now`
};

const bg_seller_activenow1 = /** @type {(inputs: {}) => string} */ () => {
	return `Активен сега`
};
...
const seller_activenow1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_seller_activenow1(inputs)
	return bg_seller_activenow1(inputs)
};
