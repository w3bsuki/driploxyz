...
const bg_auth_firstname1 = /** @type {(inputs: {}) => string} */ () => {
	return `Име`
};

const en_auth_firstname1 = /** @type {(inputs: {}) => string} */ () => {
	return `First Name`
};
...
const auth_firstname1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_auth_firstname1(inputs)
	return en_auth_firstname1(inputs)
};
