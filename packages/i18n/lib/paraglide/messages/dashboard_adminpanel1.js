...
const en_dashboard_adminpanel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Admin Panel`
};

const bg_dashboard_adminpanel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Админ панел`
};
...
const dashboard_adminpanel1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_adminpanel1(inputs)
	return bg_dashboard_adminpanel1(inputs)
};
