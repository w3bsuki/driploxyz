...
const en_pdp_careinstructions1 = /** @type {(inputs: {}) => string} */ () => {
	return `Care Instructions`
};

const bg_pdp_careinstructions1 = /** @type {(inputs: {}) => string} */ () => {
	return `Инструкции за поддръжка`
};
...
const pdp_careinstructions1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_pdp_careinstructions1(inputs)
	return bg_pdp_careinstructions1(inputs)
};
