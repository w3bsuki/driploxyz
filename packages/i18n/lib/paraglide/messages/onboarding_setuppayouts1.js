...
const en_onboarding_setuppayouts1 = /** @type {(inputs: {}) => string} */ () => {
	return `Set Up Payouts`
};

const bg_onboarding_setuppayouts1 = /** @type {(inputs: {}) => string} */ () => {
	return `Настройте плащанията`
};
...
const onboarding_setuppayouts1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_onboarding_setuppayouts1(inputs)
	return bg_onboarding_setuppayouts1(inputs)
};
