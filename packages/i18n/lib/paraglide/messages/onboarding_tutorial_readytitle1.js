...
const en_onboarding_tutorial_readytitle1 = /** @type {(inputs: {}) => string} */ () => {
	return `You're ready!`
};

const bg_onboarding_tutorial_readytitle1 = /** @type {(inputs: {}) => string} */ () => {
	return `Готови сте!`
};
...
const onboarding_tutorial_readytitle1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_onboarding_tutorial_readytitle1(inputs)
	return bg_onboarding_tutorial_readytitle1(inputs)
};
