...
const en_search_likenew1 = /** @type {(inputs: {}) => string} */ () => {
	return `Like New`
};

const bg_search_likenew1 = /** @type {(inputs: {}) => string} */ () => {
	return `Като ново`
};
...
const search_likenew1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_search_likenew1(inputs)
	return bg_search_likenew1(inputs)
};
