...
const en_sell_estimatedearnings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Estimated Earnings`
};

const bg_sell_estimatedearnings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Очаквани приходи`
};
...
const sell_estimatedearnings1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_estimatedearnings1(inputs)
	return bg_sell_estimatedearnings1(inputs)
};
