...
const bg_sell_priceandpublish2 = /** @type {(inputs: {}) => string} */ () => {
	return `Цена и публикуване`
};

const en_sell_priceandpublish2 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_priceandpublish2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_priceandpublish2(inputs)
	return en_sell_priceandpublish2(inputs)
};
