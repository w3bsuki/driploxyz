...
const en_product_shipsin1 = /** @type {(inputs: {}) => string} */ () => {
	return `Ships in`
};

const bg_product_shipsin1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изпраща за`
};
...
const product_shipsin1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_shipsin1(inputs)
	return bg_product_shipsin1(inputs)
};
