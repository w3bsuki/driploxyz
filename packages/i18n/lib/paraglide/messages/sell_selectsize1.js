...
const bg_sell_selectsize1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изберете размер`
};

const en_sell_selectsize1 = /** @type {(inputs: {}) => string} */ () => {
	return `Select size`
};
...
const sell_selectsize1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_selectsize1(inputs)
	return en_sell_selectsize1(inputs)
};
