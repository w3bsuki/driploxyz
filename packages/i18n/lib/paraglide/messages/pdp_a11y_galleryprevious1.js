...
const bg_pdp_a11y_galleryprevious1 = /** @type {(inputs: {}) => string} */ () => {
	return `Предишна снимка`
};

const en_pdp_a11y_galleryprevious1 = /** @type {(inputs: {}) => string} */ () => {
...
const pdp_a11y_galleryprevious1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_pdp_a11y_galleryprevious1(inputs)
	return en_pdp_a11y_galleryprevious1(inputs)
};
