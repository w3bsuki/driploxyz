...
const en_filter_ui_filterapplied1 = /** @type {(inputs: {}) => string} */ () => {
	return `filter applied`
};

const bg_filter_ui_filterapplied1 = /** @type {(inputs: {}) => string} */ () => {
...
const filter_ui_filterapplied1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_filter_ui_filterapplied1(inputs)
	return bg_filter_ui_filterapplied1(inputs)
};
