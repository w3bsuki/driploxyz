...
const en_category_crossbodybags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Crossbody Bags`
};

const bg_category_crossbodybags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Чанти през рамо`
};
...
const category_crossbodybags1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_crossbodybags1(inputs)
	return bg_category_crossbodybags1(inputs)
};
