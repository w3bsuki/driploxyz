...
const bg_welcome_modal_discover = /** @type {(inputs: {}) => string} */ () => {
	return `Открийте Качествена Мода`
};

const en_welcome_modal_discover = /** @type {(inputs: {}) => string} */ () => {
...
export const welcome_modal_discover = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_welcome_modal_discover(inputs)
	return en_welcome_modal_discover(inputs)
};