...
const bg_category_hairaccessories1 = /** @type {(inputs: {}) => string} */ () => {
	return `Аксесоари за коса`
};

const en_category_hairaccessories1 = /** @type {(inputs: {}) => string} */ () => {
...
const category_hairaccessories1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_category_hairaccessories1(inputs)
	return en_category_hairaccessories1(inputs)
};
