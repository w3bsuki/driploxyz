...
const bg_sell_conditionlabel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Състояние`
};

const en_sell_conditionlabel1 = /** @type {(inputs: {}) => string} */ () => {
	return `Condition`
};
...
const sell_conditionlabel1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_conditionlabel1(inputs)
	return en_sell_conditionlabel1(inputs)
};
