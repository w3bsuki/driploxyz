...
const en_sales_totalorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `Total Orders`
};

const bg_sales_totalorders1 = /** @type {(inputs: {}) => string} */ () => {
	return `Общо поръчки`
};
...
const sales_totalorders1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sales_totalorders1(inputs)
	return bg_sales_totalorders1(inputs)
};
