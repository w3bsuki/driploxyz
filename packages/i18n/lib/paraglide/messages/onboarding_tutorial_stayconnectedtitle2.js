...
const bg_onboarding_tutorial_stayconnectedtitle2 = /** @type {(inputs: {}) => string} */ () => {
	return `Останете свързани`
};

const en_onboarding_tutorial_stayconnectedtitle2 = /** @type {(inputs: {}) => string} */ () => {
...
const onboarding_tutorial_stayconnectedtitle2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_onboarding_tutorial_stayconnectedtitle2(inputs)
	return en_onboarding_tutorial_stayconnectedtitle2(inputs)
};
