...
const en_sell_yourearnings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Your Earnings`
};

const bg_sell_yourearnings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Вашите приходи`
};
...
const sell_yourearnings1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_yourearnings1(inputs)
	return bg_sell_yourearnings1(inputs)
};
