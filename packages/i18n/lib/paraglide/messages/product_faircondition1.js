...
const en_product_faircondition1 = /** @type {(inputs: {}) => string} */ () => {
	return `Fair`
};

const bg_product_faircondition1 = /** @type {(inputs: {}) => string} */ () => {
	return `Добро`
};
...
const product_faircondition1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_faircondition1(inputs)
	return bg_product_faircondition1(inputs)
};
