...
const bg_home_searchsuggestions_summerdresses2 = /** @type {(inputs: {}) => string} */ () => {
	return `Летни рокли`
};

const en_home_searchsuggestions_summerdresses2 = /** @type {(inputs: {}) => string} */ () => {
	return `Summer dresses`
};
...
const home_searchsuggestions_summerdresses2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_home_searchsuggestions_summerdresses2(inputs)
	return en_home_searchsuggestions_summerdresses2(inputs)
};
