...
const en_filter_clearall1 = /** @type {(inputs: {}) => string} */ () => {
	return `Clear All`
};

/** @type {(inputs: {}) => string} */
const bg_filter_clearall1 = () => 'filter_clearAll'
...
const filter_clearall1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_filter_clearall1(inputs)
	return en_filter_clearall1(inputs)
};
