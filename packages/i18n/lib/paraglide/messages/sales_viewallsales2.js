...
const en_sales_viewallsales2 = /** @type {(inputs: {}) => string} */ () => {
	return `View all sales`
};

const bg_sales_viewallsales2 = /** @type {(inputs: {}) => string} */ () => {
	return `Вижте всички продажби`
};
...
const sales_viewallsales2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sales_viewallsales2(inputs)
	return bg_sales_viewallsales2(inputs)
};
