...
const en_admin_driploadmin1 = /** @type {(inputs: {}) => string} */ () => {
	return `Driplo Admin`
};

const bg_admin_driploadmin1 = /** @type {(inputs: {}) => string} */ () => {
	return `Админ Driplo`
};
...
const admin_driploadmin1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_admin_driploadmin1(inputs)
	return bg_admin_driploadmin1(inputs)
};
