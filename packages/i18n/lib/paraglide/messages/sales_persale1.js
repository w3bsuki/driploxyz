...
const bg_sales_persale1 = /** @type {(inputs: {}) => string} */ () => {
	return `За продажба`
};

const en_sales_persale1 = /** @type {(inputs: {}) => string} */ () => {
	return `Per sale`
};
...
const sales_persale1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sales_persale1(inputs)
	return en_sales_persale1(inputs)
};
