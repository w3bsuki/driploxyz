...
const bg_sell_mediumconfidence1 = /** @type {(inputs: {}) => string} */ () => {
	return `Средна увереност`
};

const en_sell_mediumconfidence1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_mediumconfidence1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_mediumconfidence1(inputs)
	return en_sell_mediumconfidence1(inputs)
};
