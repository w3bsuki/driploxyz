...
const en_banner_joincommunity1 = /** @type {(inputs: {}) => string} */ () => {
	return `Join our community`
};

const bg_banner_joincommunity1 = /** @type {(inputs: {}) => string} */ () => {
	return `Присъедини се към нашата общност`
};
...
const banner_joincommunity1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_banner_joincommunity1(inputs)
	return bg_banner_joincommunity1(inputs)
};
