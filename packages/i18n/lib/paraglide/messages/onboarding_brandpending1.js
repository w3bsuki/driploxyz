...
const bg_onboarding_brandpending1 = /** @type {(inputs: {}) => string} */ () => {
	return `Брандът е в изчакване`
};

const en_onboarding_brandpending1 = /** @type {(inputs: {}) => string} */ () => {
...
const onboarding_brandpending1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_onboarding_brandpending1(inputs)
	return en_onboarding_brandpending1(inputs)
};
