...
const bg_orders_statuspending1 = /** @type {(inputs: {}) => string} */ () => {
	return `В очакване`
};

const en_orders_statuspending1 = /** @type {(inputs: {}) => string} */ () => {
	return `Pending`
};
...
const orders_statuspending1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_orders_statuspending1(inputs)
	return en_orders_statuspending1(inputs)
};
