...
const en_filter_ui_allfilterscleared2 = /** @type {(inputs: {}) => string} */ () => {
	return `All filters cleared`
};

const bg_filter_ui_allfilterscleared2 = /** @type {(inputs: {}) => string} */ () => {
	return `Всички филтри изчистени`
};
...
const filter_ui_allfilterscleared2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_filter_ui_allfilterscleared2(inputs)
	return bg_filter_ui_allfilterscleared2(inputs)
};
