...
const en_sell_colorpurple1 = /** @type {(inputs: {}) => string} */ () => {
	return `Purple`
};

const bg_sell_colorpurple1 = /** @type {(inputs: {}) => string} */ () => {
	return `Лилаво`
};
...
const sell_colorpurple1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_colorpurple1(inputs)
	return bg_sell_colorpurple1(inputs)
};
