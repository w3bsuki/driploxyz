...
const en_pdp_shippingprotection1 = /** @type {(inputs: {}) => string} */ () => {
	return `Shipping Protection`
};

const bg_pdp_shippingprotection1 = /** @type {(inputs: {}) => string} */ () => {
	return `Защита при доставка`
};
...
const pdp_shippingprotection1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_pdp_shippingprotection1(inputs)
	return bg_pdp_shippingprotection1(inputs)
};
