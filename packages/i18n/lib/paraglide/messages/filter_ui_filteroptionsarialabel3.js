...
const bg_filter_ui_filteroptionsarialabel3 = /** @type {(inputs: {}) => string} */ () => {
	return `Опции за филтри`
};

const en_filter_ui_filteroptionsarialabel3 = /** @type {(inputs: {}) => string} */ () => {
...
const filter_ui_filteroptionsarialabel3 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_filter_ui_filteroptionsarialabel3(inputs)
	return en_filter_ui_filteroptionsarialabel3(inputs)
};
