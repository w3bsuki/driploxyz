...
const bg_orders_statusshipped1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изпратено`
};

const en_orders_statusshipped1 = /** @type {(inputs: {}) => string} */ () => {
	return `Shipped`
};
...
const orders_statusshipped1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_orders_statusshipped1(inputs)
	return en_orders_statusshipped1(inputs)
};
