...
const bg_pdp_soldout1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изчерпано`
};

const en_pdp_soldout1 = /** @type {(inputs: {}) => string} */ () => {
	return `Sold Out`
};
...
const pdp_soldout1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_pdp_soldout1(inputs)
	return en_pdp_soldout1(inputs)
};
