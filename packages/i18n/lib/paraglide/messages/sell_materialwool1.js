...
const bg_sell_materialwool1 = /** @type {(inputs: {}) => string} */ () => {
	return `Вълна`
};

const en_sell_materialwool1 = /** @type {(inputs: {}) => string} */ () => {
	return `Wool`
};
...
const sell_materialwool1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_materialwool1(inputs)
	return en_sell_materialwool1(inputs)
};
