...
const en_pdp_reviewverified1 = /** @type {(inputs: {}) => string} */ () => {
	return `Verified Purchase`
};

const bg_pdp_reviewverified1 = /** @type {(inputs: {}) => string} */ () => {
	return `Потвърдена покупка`
};
...
const pdp_reviewverified1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_pdp_reviewverified1(inputs)
	return bg_pdp_reviewverified1(inputs)
};
