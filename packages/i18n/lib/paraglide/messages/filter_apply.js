...
const bg_filter_apply = /** @type {(inputs: {}) => string} */ () => {
	return `Приложи филтри`
};

const en_filter_apply = /** @type {(inputs: {}) => string} */ () => {
...
export const filter_apply = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_filter_apply(inputs)
	return en_filter_apply(inputs)
};