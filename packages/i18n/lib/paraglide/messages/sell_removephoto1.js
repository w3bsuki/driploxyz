...
const en_sell_removephoto1 = /** @type {(inputs: {}) => string} */ () => {
	return `Remove`
};

const bg_sell_removephoto1 = /** @type {(inputs: {}) => string} */ () => {
	return `Премахни`
};
...
const sell_removephoto1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_removephoto1(inputs)
	return bg_sell_removephoto1(inputs)
};
