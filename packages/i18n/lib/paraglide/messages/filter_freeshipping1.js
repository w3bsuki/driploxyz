...
const en_filter_freeshipping1 = /** @type {(inputs: {}) => string} */ () => {
	return `Free Shipping`
};

const bg_filter_freeshipping1 = /** @type {(inputs: {}) => string} */ () => {
...
const filter_freeshipping1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_filter_freeshipping1(inputs)
	return bg_filter_freeshipping1(inputs)
};
