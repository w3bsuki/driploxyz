...
const bg_admin_totalproducts1 = /** @type {(inputs: {}) => string} */ () => {
	return `Общо продукти`
};

const en_admin_totalproducts1 = /** @type {(inputs: {}) => string} */ () => {
...
const admin_totalproducts1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_admin_totalproducts1(inputs)
	return en_admin_totalproducts1(inputs)
};
