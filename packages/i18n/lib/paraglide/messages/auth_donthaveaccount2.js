...
const en_auth_donthaveaccount2 = /** @type {(inputs: {}) => string} */ () => {
	return `Don't have an account?`
};

const bg_auth_donthaveaccount2 = /** @type {(inputs: {}) => string} */ () => {
	return `Нямате акаунт?`
};
...
const auth_donthaveaccount2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_auth_donthaveaccount2(inputs)
	return bg_auth_donthaveaccount2(inputs)
};
