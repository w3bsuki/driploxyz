...
const en_pdp_viewallreviews2 = /** @type {(inputs: {}) => string} */ () => {
	return `View All Reviews`
};

const bg_pdp_viewallreviews2 = /** @type {(inputs: {}) => string} */ () => {
	return `Виж всички ревюта`
};
...
const pdp_viewallreviews2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_pdp_viewallreviews2(inputs)
	return bg_pdp_viewallreviews2(inputs)
};
