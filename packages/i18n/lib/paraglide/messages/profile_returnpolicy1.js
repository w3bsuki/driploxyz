...
const bg_profile_returnpolicy1 = /** @type {(inputs: {}) => string} */ () => {
	return `14-дневна политика за връщане`
};

const en_profile_returnpolicy1 = /** @type {(inputs: {}) => string} */ () => {
...
const profile_returnpolicy1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_profile_returnpolicy1(inputs)
	return en_profile_returnpolicy1(inputs)
};
