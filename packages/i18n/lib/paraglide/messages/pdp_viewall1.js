...
const bg_pdp_viewall1 = /** @type {(inputs: {}) => string} */ () => {
	return `Виж всички`
};

const en_pdp_viewall1 = /** @type {(inputs: {}) => string} */ () => {
	return `View All`
};
...
const pdp_viewall1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_pdp_viewall1(inputs)
	return en_pdp_viewall1(inputs)
};
