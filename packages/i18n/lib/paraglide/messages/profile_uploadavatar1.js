...
const bg_profile_uploadavatar1 = /** @type {(inputs: {}) => string} */ () => {
	return `Качи снимка`
};

/** @type {(inputs: {}) => string} */
const en_profile_uploadavatar1 = bg_profile_uploadavatar1;
...
const profile_uploadavatar1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_profile_uploadavatar1(inputs)
	return en_profile_uploadavatar1(inputs)
};
