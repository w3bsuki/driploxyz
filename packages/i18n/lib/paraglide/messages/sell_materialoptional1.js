...
const en_sell_materialoptional1 = /** @type {(inputs: {}) => string} */ () => {
	return `(optional)`
};

const bg_sell_materialoptional1 = /** @type {(inputs: {}) => string} */ () => {
	return `(по избор)`
};
...
const sell_materialoptional1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_materialoptional1(inputs)
	return bg_sell_materialoptional1(inputs)
};
