...
const bg_product_viewprofile1 = /** @type {(inputs: {}) => string} */ () => {
	return `Виж профил`
};

const en_product_viewprofile1 = /** @type {(inputs: {}) => string} */ () => {
	return `View Profile`
};
...
const product_viewprofile1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_product_viewprofile1(inputs)
	return en_product_viewprofile1(inputs)
};
