...
const bg_dashboard_alltime1 = /** @type {(inputs: {}) => string} */ () => {
	return `Общо`
};

const en_dashboard_alltime1 = /** @type {(inputs: {}) => string} */ () => {
	return `All time`
};
...
const dashboard_alltime1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_dashboard_alltime1(inputs)
	return en_dashboard_alltime1(inputs)
};
