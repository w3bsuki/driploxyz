...
const en_category_laptopbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Laptop Bags`
};

const bg_category_laptopbags1 = /** @type {(inputs: {}) => string} */ () => {
...
const category_laptopbags1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_category_laptopbags1(inputs)
	return bg_category_laptopbags1(inputs)
};
