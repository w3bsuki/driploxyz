...
const en_onboarding_totalsales1 = /** @type {(inputs: {}) => string} */ () => {
	return `Total Sales`
};

const bg_onboarding_totalsales1 = /** @type {(inputs: {}) => string} */ () => {
...
const onboarding_totalsales1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_onboarding_totalsales1(inputs)
	return bg_onboarding_totalsales1(inputs)
};
