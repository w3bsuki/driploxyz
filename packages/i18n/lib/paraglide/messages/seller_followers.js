...
const bg_seller_followers = /** @type {(inputs: {}) => string} */ () => {
	return `последователи`
};

const en_seller_followers = /** @type {(inputs: {}) => string} */ () => {
	return `followers`
};
...
export const seller_followers = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_seller_followers(inputs)
	return en_seller_followers(inputs)
};