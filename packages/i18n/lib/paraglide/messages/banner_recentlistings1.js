...
const bg_banner_recentlistings1 = /** @type {(inputs: {}) => string} */ () => {
	return `Скорошни обяви`
};

const en_banner_recentlistings1 = /** @type {(inputs: {}) => string} */ () => {
...
const banner_recentlistings1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_banner_recentlistings1(inputs)
	return en_banner_recentlistings1(inputs)
};
