...
const bg_message_nomessages1 = /** @type {(inputs: {}) => string} */ () => {
	return `Няма съобщения още`
};

const en_message_nomessages1 = /** @type {(inputs: {}) => string} */ () => {
...
const message_nomessages1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_message_nomessages1(inputs)
	return en_message_nomessages1(inputs)
};
