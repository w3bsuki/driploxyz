...
const bg_footer_madewith1 = /** @type {(inputs: {}) => string} */ () => {
	return `Направено с`
};

const en_footer_madewith1 = /** @type {(inputs: {}) => string} */ () => {
	return `Made with`
};
...
const footer_madewith1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_footer_madewith1(inputs)
	return en_footer_madewith1(inputs)
};
