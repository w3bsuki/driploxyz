...
const bg_sell_applysuggestions1 = /** @type {(inputs: {}) => string} */ () => {
	return `Приложи предложенията`
};

const en_sell_applysuggestions1 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_applysuggestions1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_applysuggestions1(inputs)
	return en_sell_applysuggestions1(inputs)
};
