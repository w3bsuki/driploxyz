...
const en_orders_toreview1 = /** @type {(inputs: {}) => string} */ () => {
	return `To Review`
};

const bg_orders_toreview1 = /** @type {(inputs: {}) => string} */ () => {
	return `За преглед`
};
...
const orders_toreview1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_orders_toreview1(inputs)
	return bg_orders_toreview1(inputs)
};
