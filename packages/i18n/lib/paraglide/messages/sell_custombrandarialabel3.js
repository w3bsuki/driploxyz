...
const en_sell_custombrandarialabel3 = /** @type {(inputs: {}) => string} */ () => {
	return `Custom brand name`
};

const bg_sell_custombrandarialabel3 = /** @type {(inputs: {}) => string} */ () => {
	return `Персонализирано име на марка`
};
...
const sell_custombrandarialabel3 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_sell_custombrandarialabel3(inputs)
	return bg_sell_custombrandarialabel3(inputs)
};
