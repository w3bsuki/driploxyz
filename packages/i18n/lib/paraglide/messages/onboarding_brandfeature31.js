...
const en_onboarding_brandfeature31 = /** @type {(inputs: {}) => string} */ () => {
	return `Priority support`
};

const bg_onboarding_brandfeature31 = /** @type {(inputs: {}) => string} */ () => {
...
const onboarding_brandfeature31 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_onboarding_brandfeature31(inputs)
	return bg_onboarding_brandfeature31(inputs)
};
