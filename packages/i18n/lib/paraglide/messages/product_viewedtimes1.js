...
const en_product_viewedtimes1 = /** @type {(inputs: {}) => string} */ () => {
	return `Viewed times`
};

const bg_product_viewedtimes1 = /** @type {(inputs: {}) => string} */ () => {
	return `Прегледан пъти`
};
...
const product_viewedtimes1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_viewedtimes1(inputs)
	return bg_product_viewedtimes1(inputs)
};
