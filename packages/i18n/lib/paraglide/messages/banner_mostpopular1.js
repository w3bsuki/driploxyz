...
const en_banner_mostpopular1 = /** @type {(inputs: {}) => string} */ () => {
	return `Most Popular`
};

const bg_banner_mostpopular1 = /** @type {(inputs: {}) => string} */ () => {
...
const banner_mostpopular1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_banner_mostpopular1(inputs)
	return bg_banner_mostpopular1(inputs)
};
