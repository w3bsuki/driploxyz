...
const bg_product_shippingcosts1 = /** @type {(inputs: {}) => string} */ () => {
	return `Цени за доставка`
};

const en_product_shippingcosts1 = /** @type {(inputs: {}) => string} */ () => {
...
const product_shippingcosts1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_product_shippingcosts1(inputs)
	return en_product_shippingcosts1(inputs)
};
