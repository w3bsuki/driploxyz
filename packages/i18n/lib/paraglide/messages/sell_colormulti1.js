...
const bg_sell_colormulti1 = /** @type {(inputs: {}) => string} */ () => {
	return `Многоцветно`
};

const en_sell_colormulti1 = /** @type {(inputs: {}) => string} */ () => {
	return `Multi`
};
...
const sell_colormulti1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_colormulti1(inputs)
	return en_sell_colormulti1(inputs)
};
