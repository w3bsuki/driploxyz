...
const en_product_standardshipping1 = /** @type {(inputs: {}) => string} */ () => {
	return `Standard`
};

const bg_product_standardshipping1 = /** @type {(inputs: {}) => string} */ () => {
	return `Стандартна`
};
...
const product_standardshipping1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_product_standardshipping1(inputs)
	return bg_product_standardshipping1(inputs)
};
