...
const bg_filter_modal_clearall1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изчисти всички`
};

const en_filter_modal_clearall1 = /** @type {(inputs: {}) => string} */ () => {
	return `Clear All`
};
...
const filter_modal_clearall1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_filter_modal_clearall1(inputs)
	return en_filter_modal_clearall1(inputs)
};
