...
const en_dashboard_processingtime1to2days2 = /** @type {(inputs: {}) => string} */ () => {
	return `1-2 business days`
};

const bg_dashboard_processingtime1to2days2 = /** @type {(inputs: {}) => string} */ () => {
...
const dashboard_processingtime1to2days2 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_dashboard_processingtime1to2days2(inputs)
	return bg_dashboard_processingtime1to2days2(inputs)
};
