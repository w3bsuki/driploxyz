...
const bg_error_unauthorized = /** @type {(inputs: {}) => string} */ () => {
	return `Неоторизиран достъп`
};

const en_error_unauthorized = /** @type {(inputs: {}) => string} */ () => {
...
export const error_unauthorized = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_error_unauthorized(inputs)
	return en_error_unauthorized(inputs)
};