...
/** @type {(inputs: {}) => string} */
const en_subcategory_pantsjeans1 = bg_subcategory_pantsjeans1;
...
const subcategory_pantsjeans1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_subcategory_pantsjeans1(inputs)
	return en_subcategory_pantsjeans1(inputs)
};
