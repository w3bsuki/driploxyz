...
const bg_sell_minphotosrequired2 = /** @type {(inputs: {}) => string} */ () => {
	return `Необходима е поне 1 снимка`
};

const en_sell_minphotosrequired2 = /** @type {(inputs: {}) => string} */ () => {
...
const sell_minphotosrequired2 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_minphotosrequired2(inputs)
	return en_sell_minphotosrequired2(inputs)
};
