...
const bg_filter_newtoday1 = /** @type {(inputs: {}) => string} */ () => {
	return `Нови днес`
};

const en_filter_newtoday1 = /** @type {(inputs: {}) => string} */ () => {
	return `New Today`
};
...
const filter_newtoday1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_filter_newtoday1(inputs)
	return en_filter_newtoday1(inputs)
};
