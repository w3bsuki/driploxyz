...
const en_pdp_viewsone1 = /** @type {(inputs: {}) => string} */ () => {
	return `1 view`
};

const bg_pdp_viewsone1 = /** @type {(inputs: {}) => string} */ () => {
	return `1 преглед`
};
...
const pdp_viewsone1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_pdp_viewsone1(inputs)
	return bg_pdp_viewsone1(inputs)
};
