...
const bg_category_shoulderbags1 = /** @type {(inputs: {}) => string} */ () => {
	return `Чанти за рамо`
};

const en_category_shoulderbags1 = /** @type {(inputs: {}) => string} */ () => {
...
const category_shoulderbags1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_category_shoulderbags1(inputs)
	return en_category_shoulderbags1(inputs)
};
