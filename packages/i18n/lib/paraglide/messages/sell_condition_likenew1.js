...
const bg_sell_condition_likenew1 = /** @type {(inputs: {}) => string} */ () => {
	return `Като ново`
};

const en_sell_condition_likenew1 = /** @type {(inputs: {}) => string} */ () => {
	return `Like new`
};
...
const sell_condition_likenew1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_sell_condition_likenew1(inputs)
	return en_sell_condition_likenew1(inputs)
};
