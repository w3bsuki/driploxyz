...
const en_upgrade_freeplan1 = /** @type {(inputs: {}) => string} */ () => {
	return `Free Plan`
};

const bg_upgrade_freeplan1 = /** @type {(inputs: {}) => string} */ () => {
...
const upgrade_freeplan1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_upgrade_freeplan1(inputs)
	return bg_upgrade_freeplan1(inputs)
};
