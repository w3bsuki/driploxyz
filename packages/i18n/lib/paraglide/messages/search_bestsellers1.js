...
const bg_search_bestsellers1 = /** @type {(inputs: {}) => string} */ () => {
	return `Най-продавани`
};

const en_search_bestsellers1 = /** @type {(inputs: {}) => string} */ () => {
	return `Best Sellers`
};
...
const search_bestsellers1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_search_bestsellers1(inputs)
	return en_search_bestsellers1(inputs)
};
