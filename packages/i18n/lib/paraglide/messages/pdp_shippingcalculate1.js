...
const en_pdp_shippingcalculate1 = /** @type {(inputs: {}) => string} */ () => {
	return `Calculate Shipping`
};

const bg_pdp_shippingcalculate1 = /** @type {(inputs: {}) => string} */ () => {
	return `Изчисли доставка`
};
...
const pdp_shippingcalculate1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_pdp_shippingcalculate1(inputs)
	return bg_pdp_shippingcalculate1(inputs)
};
