...
const en_orders_messageseller1 = /** @type {(inputs: {}) => string} */ () => {
	return `Message Seller`
};

/** @type {(inputs: {}) => string} */
const bg_orders_messageseller1 = en_orders_messageseller1;
...
const orders_messageseller1 = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_orders_messageseller1(inputs)
	return bg_orders_messageseller1(inputs)
};
