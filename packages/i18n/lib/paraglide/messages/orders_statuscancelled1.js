...
const bg_orders_statuscancelled1 = /** @type {(inputs: {}) => string} */ () => {
	return `Отменено`
};

const en_orders_statuscancelled1 = /** @type {(inputs: {}) => string} */ () => {
	return `Cancelled`
};
...
const orders_statuscancelled1 = (inputs = {}, options = {}) => {
	...
	if (locale === "bg") return bg_orders_statuscancelled1(inputs)
	return en_orders_statuscancelled1(inputs)
};
