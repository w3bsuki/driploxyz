<script lang="ts">
  ...
  const baseClasses = 'block w-full rounded-lg border px-3 py-2 text-sm bg-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 appearance-none cursor-pointer';
