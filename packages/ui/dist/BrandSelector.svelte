  ...
  {#if showCustomInput}
    <div class="mt-3 p-1">
      <input
        ...
        {placeholder}
        {disabled}
        class="block w-full rounded-lg border px-3 py-2 text-sm placeholder-gray-500 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 focus:border-blue-500
          {error 
