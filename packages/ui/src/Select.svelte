<script lang="ts">
  ...
  const baseClasses = 'block w-full rounded-lg border px-3 py-2 text-sm bg-white transition-colors focus:outline-none focus:ring-1 appearance-none cursor-pointer';
