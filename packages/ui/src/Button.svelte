<script lang="ts">
  ...
  const variantClasses = {
    ...
    secondary: 'bg-gray-100 text-gray-900 focus-visible:ring-gray-500',
    outline: 'border border-gray-300 bg-white text-gray-700 focus-visible:ring-gray-500',
    ghost: 'text-gray-700 focus-visible:ring-gray-500',
