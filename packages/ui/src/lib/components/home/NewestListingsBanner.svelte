<script lang="ts">
  ...
  const classes = {
    shell: 'relative isolate w-full overflow-hidden rounded-lg border border-white/12 bg-orange-600/95 px-4 py-5 text-white shadow-md shadow-orange-950/10 sm:px-6 sm:py-6 lg:px-8 lg:py-7',
    ...
    ctaButton: 'inline-flex w-full items-center justify-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-orange-600 transition hover:bg-orange-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-500 md:w-auto md:justify-self-end md:text-base'
  } as const;
