<script lang="ts">
  ...
  const classes = {
    shell: 'relative isolate w-full overflow-hidden rounded-lg border border-white/12 bg-gradient-to-r from-sky-500 via-sky-400 to-blue-600 px-4 py-5 text-white shadow-lg shadow-sky-950/15 sm:px-6 sm:py-6 lg:px-8 lg:py-7',
    ...
    meta: 'inline-flex items-center gap-1 rounded-full bg-white/12 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.28em] text-white/70 backdrop-blur',
