      ...
      <div class="flex items-start gap-3">
        ...
        {#if seller?.avatar_url}
          <img 
            ...
            class="w-8 h-8 rounded-md object-cover bg-[color:var(--gray-100)] border border-[color:var(--gray-200)] flex-shrink-0"
            loading="lazy"
          />
        {:else}
          <div class="w-8 h-8 rounded-md bg-[color:var(--gray-200)] border border-[color:var(--gray-300)] flex items-center justify-center flex-shrink-0">
