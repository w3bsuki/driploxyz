    ...
    <div class="flex items-center gap-2">
      ...
      <button
        ...
        class="flex items-center justify-center gap-2 h-12 px-3 sm:px-4 
               bg-(--surface-base) border border-(--border-subtle) rounded-xl
      ...
      >
        ...
        <span class="hidden sm:inline text-sm font-medium text-(--text-primary)">Browse</span>
      </button>
      ...
      >
        ...
        <span class="hidden sm:inline text-sm font-medium text-(--text-primary)">Filters</span>
        ...
        {#if activeFilterCount > 0}
          <div class="absolute -top-1 -right-1 sm:-top-2 sm:-right-2
                      ...
                      min-w-5 h-5 px-1.5
                      bg-(--brand-primary) text-(--surface-base) text-xs font-bold rounded-full
