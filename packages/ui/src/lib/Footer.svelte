      ...
      <div class="space-y-4">
        ...
        <form onsubmit={handleNewsletterSubmit} class="space-y-3">
          <div class="flex gap-2">
            <input
              ...
              class="flex-1 min-h-[36px] px-3 py-2 text-sm border border-gray-300 rounded-lg 
        ...
        <div class="space-y-3">
          ...
          <div class="flex space-x-3">
            ...
            >
              <svg class="w-4 h-4 text-gray-600 group-hover:text-gray-900" fill="currentColor" viewBox="0 0 24 24">
