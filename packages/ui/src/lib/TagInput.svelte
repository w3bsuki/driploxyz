...
<div class={`tag-input ${className}`}>
  ...
  <div class="relative">
    <div class="min-h-[42px] rounded-lg border px-3 py-2 flex flex-wrap gap-2 items-center transition-all duration-200 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-transparent
      {error 
