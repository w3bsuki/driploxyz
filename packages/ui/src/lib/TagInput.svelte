...
<div class={`tag-input ${className}`}>
  ...
  <div class="relative">
    <div class="min-h-[42px] rounded-lg border-2 px-3 py-2 flex flex-wrap gap-2 items-center transition-all duration-200 focus-within:ring-4 focus-within:ring-blue-500/20 focus-within:border-blue-500
      {error 
