    ...
    <div class="space-y-1">
      ...
      <div>
        ...
        <input
          ...
          class="appearance-none block w-full px-3 py-2 border-2 {form?.errors?.fullName ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'} rounded-lg placeholder-gray-400 focus:outline-none transition-colors text-base sm:text-sm"
      ...
      <div>
        ...
        <input
          ...
          class="appearance-none block w-full px-3 py-2 border-2 {form?.errors?.email ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'} rounded-lg placeholder-gray-400 focus:outline-none transition-colors text-base sm:text-sm"
      ...
      <div>
        ...
        <input
          ...
          class="appearance-none block w-full px-3 py-2 border-2 {form?.errors?.password ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'} rounded-lg placeholder-gray-400 focus:outline-none transition-colors text-base sm:text-sm"
      ...
      <div>
        ...
        <input
          ...
          class="appearance-none block w-full px-3 py-2 border-2 {form?.errors?.confirmPassword ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-500'} rounded-lg placeholder-gray-400 focus:outline-none transition-colors text-base sm:text-sm"
