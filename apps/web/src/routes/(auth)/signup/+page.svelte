    ...
    <div class="space-y-1">
      ...
      <div>
        ...
        <input
          ...
          class="appearance-none block w-full px-3 py-2 border {form?.errors?.fullName ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'} rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors text-base sm:text-sm"
      ...
      <div>
        ...
        <input
          ...
          class="appearance-none block w-full px-3 py-2 border {form?.errors?.confirmPassword ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'} rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors text-base sm:text-sm"
