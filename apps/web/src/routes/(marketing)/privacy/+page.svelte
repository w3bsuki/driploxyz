	...
	<div class="max-w-4xl mx-auto">
		...
		<div class="bg-white shadow-sm rounded-lg p-6 prose prose-gray max-w-none">
			...
			<section>
				...
				<p>
					To exercise these rights, contact us at <a href="mailto:privacy@driplo.xyz">privacy@driplo.xyz</a>
				</p>
			</section>
			...
			<section>
				...
				<p>
					...
					through our <a href="/privacy/cookies">Cookie Policy</a> 
			...
			<section>
				...
				<div class="bg-gray-50 rounded-lg p-4">
					...
					<ul>
						<li>Email: <a href="mailto:privacy@driplo.xyz">privacy@driplo.xyz</a></li>
